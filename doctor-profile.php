...
<head>
    ...
    <link rel="canonical" href="https://rajhospitals.com/doctor-profile" />
</head>
   ...
   <?php include $base_url . 'components/navbar.php'; ?>
             ...
             <div class="p-4">
                ...
                <form accept-charset="UTF-8" action="https://app.formester.com/forms/kIewn1CO8/submissions" method="POST" class="space-y-3">
                     ...
                     <div>
                        ...
                        <input type="text" required class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 outline-none" name="name" placeholder="Enter your full name">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-1">Phone Number <span class="text-red-500">*</span></label>
                        <input type="tel" required pattern="[0-9]{10}" class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 outline-none" name="phone" placeholder="Enter 10-digit mobile number">
                    </div>
    ...
    <script>
        const doctorsData = [
            ...
            { id: 'ashish-modi', name: 'Dr. Ashish Kumar Modi', qualifications: 'MBBS, MS (General Surgery), FMAS', specialty: 'Minimal Access Surgery', experience: '12+ Years', image: 'assets/new-doctors-side/Dr. Ashish Kumar Modi-new.png', hasStaticPage: true },
            ...
            { id: 'neelam-kumari', name: 'Dr. Neelam Kumari', qualifications: 'MBBS, MD', specialty: 'Internal Medicine', experience: '8+ Years', image: 'assets/Raj-hospital-doctor-image/Raj-hospital-doctor-image/General Physician - Dr. Neelam-Kumari.webp', hasStaticPage: true },
            ...
            { id: 'avinash-dubey', name: 'Dr. Avinash Kumar Dubey', qualifications: 'MBBS, MD, DM', specialty: 'Nephrology', experience: '15+ Years', image: 'assets/Raj-hospital-doctor-image/Raj-hospital-doctor-image/Nephrologist - Dr. Avinas- Kumar-Dubey.webp', hasStaticPage: true },
            ...
            { id: 'ujjwal-sinha', name: 'Dr. Ujjwal Sinha', qualifications: 'MBBS, DNB, MNAMS, Fellowship in Sports Medicine, FIJR (Singapore)', specialty: 'Orthopaedics & Joint Replacement', experience: '15+ Years', image: 'assets/doctor-latest/Orthopedic Surgeon - Dr. Ujjwal Sinha.webp' },
            ...
            { id: 'pushpa-sinha', name: 'Dr. Pushpa Sinha', qualifications: 'MBBS, MD, DGO', specialty: 'Obstetrics & Gynaecology', experience: '15+ Years', image: 'assets/doctor-latest/Gyanecologist - Dr. Pushpa Sinha.webp' },
            { id: 'pankaj-kumar', name: 'Dr. Pankaj Kumar', qualifications: 'MBBS, MS, MCh', specialty: 'Aesthetic & Reconstructive Surgery', experience: '12+ Years', image: 'assets/doctor-latest/pankaj-kumar-raj.webp' },
            ...
            { id: 'shagun-raj', name: 'Dr. Shagun Raj', qualifications: 'MD Dermatology', specialty: 'Dermatology', experience: '', image: 'assets/doctor-latest/Dr-Shagun.webp', hasStaticPage: true },
            ...
            { id: 'abhishek-bhattacharjee', name: 'Dr. Abhishek Bhattacharjee', qualifications: 'BDS, MDS', specialty: 'Dental', experience: '10+ Years', image: 'assets/Raj-hospital-doctor-image/Raj-hospital-doctor-image/Maxillofacial Surgeon - Dr. Abhishek-Bhattacharjee.webp' },
            // Critical Care (4 doctors)
            { id: 'saurabh-kumar', name: 'Dr. Saurabh Kumar', qualifications: 'MBBS, MD', specialty: 'Critical Care', experience: '26+ Years', image: 'assets/new-doctors-side/Dr. Saurabh Kumar.webp' },
            { id: 'pradeep-prasad', name: 'Dr. Pradeep Prasad', qualifications: 'MBBS, MD', specialty: 'FNAC, Biopsy, Blood & Laboratory', experience: '10+ Years', image: 'assets/new-doctors-side/pradeep prasad.webp' },
            { id: 'jitendra-prasad', name: 'Dr. Jitendra Prasad', qualifications: 'MBBS, MD', specialty: 'FNAC, Biopsy, Blood & Laboratory', experience: '9+ Years', image: 'assets/doctor-latest/dr-jitendra-lab.webp' },
            ...
            { id: 'shekhar-sharma', name: 'Dr. Shekhar Sharma', qualifications: 'MBBS, DMRD, PGT', specialty: 'Radiology', experience: '20+ Years', image: 'assets/Doc-Side/Dr Shekhar Sharma (Radiologist).webp' },
            ...
            { id: 'prakash-chandra', name: 'Dr. Prakash Chandra', qualifications: 'MBBS, MS, MCH', specialty: 'Neuro & Spine Surgery', experience: '50+ Years', image: 'assets/Doc-Side/Dr. Prakash Chandra (Neuro Surgeon).webp' },
                        ...
                        <div class="md:flex md:items-start md:gap-12">
                             ...
                             <div class="w-full md:w-96 md:sticky md:top-32 self-start rounded-2xl shadow-md bg-white p-6 border border-gray-100 mt-12 md:mt-0">
                                <form accept-charset="UTF-8" action="https://app.formester.com/forms/kIewn1CO8/submissions" method="POST" class="space-y-6">
                                    ...
                                    <input type="text" name="name" placeholder="Enter your name" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 outline-none">
                                    <input type="tel" name="phone" placeholder="Enter mobile number" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 outline-none">
                                    <input type="email" name="email" placeholder="Enter email" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 outline-none">
                                    <textarea rows="3" name="message" placeholder="Type your query" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 outline-none"></textarea>
