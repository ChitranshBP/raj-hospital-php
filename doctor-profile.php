   ...
   <?php include $base_url . 'components/navbar.php'; ?>
    ...
    <script>
        const doctorsData = [
            ...
            { id: 'ujjwal-sinha', name: 'Dr. Ujjwal Sinha', qualifications: 'MBBS, MS, DNB', specialty: 'Orthopaedics & Joint Replacement', experience: '15+ Years', image: 'assets/doctor-latest/Orthopedic Surgeon - Dr. Ujjwal Sinha.webp' },
