            ...
            <div class="relative px-4 md:px-0">
                ...
                <div class="space-y-12">
                    ...
                    <div class="relative flex flex-col md:flex-row-reverse items-center gap-8 fade-in">
                        ...
                        <div class="hidden md:block w-5/12 pr-8">
                             <div class="h-64 bg-gray-200 rounded-xl overflow-hidden shadow-md"><img src="assets/About-img/mri_machine_2003.png" class="w-full h-full object-cover"></div>
                        </div>
                    </div>
                    ...
                    <div class="relative flex flex-col md:flex-row-reverse items-center gap-8 fade-in">
                     ...
                     <div class="relative flex flex-col md:flex-row items-center gap-8 fade-in">
                        ...
                        <div class="w-full md:w-5/12 pl-16 md:pl-0 md:text-right md:pr-8">
                             <div class="bg-white rounded-xl shadow-md p-5 border-l-4 md:border-l-0 md:border-r-4 border-orange-500 hover:shadow-lg transition">
                                <span class="inline-block px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-sm font-bold mb-3">June 2024</span>
                                <ul class="space-y-2 text-left md:text-right">
                                    <li class="text-sm text-gray-700">Accredited by the Indian Society of Critical Care Medicine (ISCCM)</li>
                                    <li class="text-sm text-gray-700">Approved for Indian Diploma in Critical Care Medicine (IDCCM)</li>
                                    <li class="text-sm text-gray-700">Approved for Indian Diploma in Critical Care Nursing (IDCCN)</li>
                                </ul>
                             </div>
                        </div>
                        <div class="hidden md:block w-5/12 pl-8">
                             <div class="h-64 bg-gray-200 rounded-xl overflow-hidden shadow-md"><img src="assets/About-img/isccm_accreditation_2024.png" class="w-full h-full object-cover"></div>
                        </div>
                    </div>
