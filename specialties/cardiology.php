...
<head>
    ...
    <meta name="description" content="Expert cardiology care at Raj Hospitals, Ranchi. Advanced heart treatments including angiography, angioplasty, leadless pacemakers, and 24/7 heart attack care by experienced cardiologists.">
...
<body class="bg-white">
    ...
    <section class="relative h-[50vh] mt-20 overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img src="../assets/specialties/Cardiology/Banner-2-cardio.webp" alt="Cardiology" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 h-full flex items-center">
            <div class="max-w-7xl mx-auto px-4 w-full">
                <div class="max-w-3xl text-white fade-in">
                    ...
                    <p class="text-xl text-gray-200">Expert care for heart diseases with state-of-the-art technology and experienced cardiologists</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2">
                    <div class="fade-in">
                        ...
                        <p class="text-lg text-gray-700 leading-relaxed mb-6">Our Cardiology Department at Raj Hospitals is equipped with cutting-edge technology and staffed by experienced cardiologists who specialize in diagnosing and treating a wide range of heart conditions. From preventive care to complex interventions, we provide comprehensive cardiac care to improve heart health and quality of life for our patients.</p>
                    ...
                    <div class="flex flex-col gap-8 overflow-y-auto" style="max-height: 1000px; max-width: 340px; margin: 0 auto;">
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full" style="min-height: 500px;">
                            <div class="relative h-48 overflow-hidden">
                                <img src="../assets/Raj-hospital-doctor-image/Raj-hospital-doctor-image/Cardiologist - Dr. Rajesh-Kumar Jha.webp" alt="Dr. Rajesh Kr. Jha" class="w-full h-full object-cover object-top">
                            </div>
                            <div class="p-6">
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full" style="min-height: 500px;">
                            <div class="relative h-48 overflow-hidden">
                                <img src="../assets/Raj-hospital-doctor-image/Raj-hospital-doctor-image/-Dr. Awnindra-Kumar-Singh-Cardiologist.webp" alt="Dr. Awnindra Kumar Singh" class="w-full h-full object-cover object-top">
                            </div>
                            <div class="p-6">
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full" style="min-height: 500px;">
                            <div class="relative h-48 overflow-hidden">
                                <img src="../assets/Doc-Side/Dr Anup Kumar Jha_.webp" alt="Dr. Anup Kumar Jha" class="w-full h-full object-cover object-top">
                            </div>
                            <div class="p-6">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Cardiology/Daycare-Angiography.webp" alt="Daycare Angiography" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Daycare Angiography</h3>
                        <p class="text-gray-600 mb-4">Safe and efficient angiography performed as a daycare procedure for accurate diagnosis of heart conditions.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Cardiology/Angioplasty.webp" alt="Angioplasty" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Angioplasty</h3>
                        <p class="text-gray-600 mb-4">Minimally invasive procedure to restore blood flow in narrowed or blocked coronary arteries using stents.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Cardiology/IVUS -Colling & RFA.webp" alt="IVUS, Colling & RFA" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">IVUS, Colling & RFA</h3>
                        <p class="text-gray-600 mb-4">Advanced imaging and therapeutic techniques including Intravascular Ultrasound (IVUS), Colling, and Radiofrequency Ablation (RFA).</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Cardiology/Leadless-Pacemaker.webp" alt="Leadless Pacemaker" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Leadless Pacemaker</h3>
                        <p class="text-gray-600 mb-4">Latest generation pacemaker technology without leads, offering safer and less invasive rhythm management.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Cardiology/Heart-Attack (MI) Care.webp" alt="Heart Attack Care" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Heart Attack (MI) Care</h3>
                        <p class="text-gray-600 mb-4">24x7 emergency care for patients with myocardial infarction (heart attack) to minimize damage and save lives.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Cardiology/Heart-Failure.webp" alt="Heart Failure Management" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Heart Failure Management</h3>
                        <p class="text-gray-600 mb-4">Comprehensive long-term management of heart failure patients with medication, lifestyle care, and device therapy.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-8 rounded-xl shadow-md fade-in">
                    ...
                    <p class="text-gray-700 mb-6">Sunita had severe blockages in multiple coronary arteries that weren't suitable for stenting. Our cardiac surgeons performed a complex bypass surgery, creating new routes for blood flow to her heart. Despite being a high-risk case due to her diabetes and hypertension, the surgery was successful.</p>
                    <div class="bg-green-50 p-4 rounded-lg border border-green-100">
                        <div class="flex items-center space-x-2">
                            <i data-feather="check" class="w-5 h-5 text-green-600"></i>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">What are the warning signs of a heart attack?</h3>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">How often should I get a cardiac check-up?</h3>
                                <i data-feather="plus" class="text-2xl text-primary-500 flex-shrink-0 ml-4 faq-icon"></i>
                            </div>
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>For adults over 40, an annual cardiac check-up is recommended. Those with risk factors like high blood pressure, diabetes, high cholesterol, family history of heart disease, or smoking should consider more frequent check-ups as advised by their doctor. Basic cardiac screening includes blood pressure measurement, cholesterol testing, and ECG.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">What lifestyle changes can improve heart health?</h3>
                                <i data-feather="plus" class="text-2xl text-primary-500 flex-shrink-0 ml-4 faq-icon"></i>
                            </div>
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Key lifestyle changes include regular physical activity (at least 150 minutes of moderate exercise per week), maintaining a heart-healthy diet (low in saturated fats, trans fats, and sodium), maintaining healthy weight, quitting smoking, limiting alcohol consumption, managing stress, and getting adequate sleep.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">What is the recovery time after angioplasty?</h3>
                                <i data-feather="plus" class="text-2xl text-primary-500 flex-shrink-0 ml-4 faq-icon"></i>
                            </div>
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Most patients can return to light activities within a week after angioplasty. Full recovery typically takes about 2-4 weeks. However, recovery time varies based on individual health conditions and the complexity of the procedure. Follow-up appointments are essential to monitor progress and adjust medications if necessary.</p>
                            </div>
                        </div>
                    </div>
                </div>
