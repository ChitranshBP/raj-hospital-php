...
<head>
    ...
    <meta name="description" content="Best Neurologist Hospital in Ranchi offering comprehensive brain and spine care by expert neuro physicians.">
...
<body class="bg-white">
    ...
    <section class="relative h-[50vh] mt-20 overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img src="../assets/specialties/Neuroscience/Neurological-Diagnostics.webp" alt="Neurosciences" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 h-full flex items-center">
            <div class="max-w-7xl mx-auto px-4 w-full">
                <div class="max-w-3xl text-white fade-in">
                    ...
                    <p class="text-xl text-gray-200">Best Neurologist Hospital in Ranchi offering comprehensive brain and spine care by expert neuro physicians.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2">
                    <div class="fade-in">
                        ...
                        <p class="text-lg text-gray-700 leading-relaxed mb-6">The Department of Neurosciences at Raj Hospitals provides comprehensive and multidisciplinary care for brain and spine disorders. Our team of expert neurologists, neurosurgeons, and interventional neuro-radiologists utilize the latest technologies to diagnose and treat a wide range of neurological conditions. We provide integrated care for stroke, epilepsy, movement disorders, neuro infections, brain tumors, spinal injuries, and more with specialized emergency and surgical services.</p>
                        ...
                        <div class="bg-primary-50 p-6 rounded-xl border border-primary-100 mb-8">
                            <h3 class="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                                ...
                                Why Choose Our Neurosciences Department
                            </h3>
                            <ul class="space-y-3">
                    ...
                    <div class="fade-in mb-12">
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-2 h-2 bg-primary-500 rounded-full"></div>
                                    <span class="text-gray-700">Modern operating rooms with endoscopes and microscopes</span>
                                </div>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-2 h-2 bg-primary-500 rounded-full"></div>
                                    <span class="text-gray-700">24/7 emergency neurology and neurosurgery services</span>
                                </div>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-2 h-2 bg-primary-500 rounded-full"></div>
                                    <span class="text-gray-700">Interventional neuro-radiology facilities</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-8 overflow-y-auto" style="max-height: 1000px; max-width: 340px; margin: 0 auto;">
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full" style="min-height: 500px;">
                            <div class="relative h-48 overflow-hidden">
                                <img src="../assets/Doc-Side/Dr Ahmad Hussain.webp" alt="Dr. Ahmad Hussain" class="w-full h-full object-cover object-top">
                            </div>
                            <div class="p-6">
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full" style="min-height: 500px;">
                            <div class="relative h-48 overflow-hidden">
                                <img src="../assets/Raj-hospital-doctor-image/Raj-hospital-doctor-image/Neurosurgeon - Dr. Vivek-Raj.webp" alt="Dr. Vivek Raj" class="w-full h-full object-cover object-top">
                            </div>
                            <div class="p-6">
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full" style="min-height: 500px;">
                            <div class="relative h-48 overflow-hidden">
                                <img src="../assets/Doc-Side/vijayraj.webp" alt="Dr. Vijay Raj" class="w-full h-full object-cover object-top">
                            </div>
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-gray-900 mb-1">Dr. Vijay Raj</h3>
                                <p class="text-primary-600 font-medium mb-2">MBBS, MD, DM (Neurology)</p>
                                <p class="text-secondary-600 text-sm mb-3">Neurodiagnostics and Stroke Management</p>
                                <div class="flex items-center text-sm text-gray-500 mb-4">
                                    <i data-feather="award" class="w-4 h-4 mr-2"></i>
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-12 fade-in">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Comprehensive Neurosciences care with advanced techniques and personalized treatment plans
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Neurology/Brai- Stroke-Unit & Seizures.webp" alt="Brain Stroke Unit & Seizures" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Brain Stroke Unit & Seizures</h3>
                        <p class="text-gray-600 mb-4">Specialized stroke unit with continuous monitoring and seizure control.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Neurology/Epilepsy.webp" alt="Epilepsy" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Epilepsy</h3>
                        <p class="text-gray-600 mb-4">Diagnosis, medical management, and surgical options for seizure disorders.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Neurology/Brain & Spine-Tumor-Surgery.webp" alt="Brain & Spine Tumor Surgery" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Brain & Spine Tumor Surgery</h3>
                        <p class="text-gray-600 mb-4">Advanced neurosurgical removal and care for tumors.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Neurology/Movement-Disorders.webp" alt="Movement Disorders" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Movement Disorders</h3>
                        <p class="text-gray-600 mb-4">Extensive care for complex movement disorders.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Neurology/Awake-Brain-Surgery.webp" alt="Awake Brain Surgery" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Awake Brain Surgery</h3>
                        <p class="text-gray-600 mb-4">State-of-the-art awake craniotomy for tumor and functional brain surgery.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Neurology/Spinal-Cor- Injury.webp" alt="Spinal Cord Injury" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Spinal Cord Injury</h3>
                        <p class="text-gray-600 mb-4">Expert treatment and surgeries for spine trauma and disorders.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-8 bg-gradient-to-r from-gray-50 to-blue-50">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-12 fade-in">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Common conditions we diagnose and treat in our Neurosciences department
                </p>
            </div>
            ...
            <div class="bg-white rounded-xl p-8 shadow-sm border border-gray-100 fade-in">
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-4">
                    ...
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Back Pain & Sciatica</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
    ...
    <section class="py-8 bg-gradient-to-br from-primary-50 to-secondary-50">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-12 fade-in">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Real stories of healing and recovery from our Neurosciences department
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-8 rounded-xl shadow-md fade-in">
                    ...
                    <p class="text-gray-700 mb-6">Rapid emergency neurological care helped me recover optimal function after a major stroke. Their dedicated stroke unit made all the difference.</p>
                    <div class="bg-green-50 p-4 rounded-lg border border-green-100">
                        <div class="flex items-center space-x-2">
                            <i data-feather="check" class="w-5 h-5 text-green-600"></i>
                            <span class="font-medium text-green-800">Outcome: Regained independence after 3 months rehabilitation.</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-md fade-in">
                    <div class="flex items-center space-x-3 mb-4">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900">Effective Epilepsy Treatment</h3>
                    </div>
                    <p class="text-gray-500 mb-4">Patient: Ms. Sharma</p>
                    <p class="text-gray-700 mb-6">I have been seizure-free after comprehensive medication management and proper monitoring by the neurology team.</p>
                    <div class="bg-green-50 p-4 rounded-lg border border-green-100">
                        <div class="flex items-center space-x-2">
                            <i data-feather="check" class="w-5 h-5 text-green-600"></i>
                            <span class="font-medium text-green-800">Outcome: Improved quality of life and seizure control.</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-8 bg-white">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Common questions about Neurosciences conditions and treatments
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">What are common neurological disorders treated?</h3>
                            ...
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Stroke, epilepsy, Parkinson's disease, multiple sclerosis, neuropathies, brain and spine tumors, and movement disorders.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">Are pediatric neurological surgeries available?</h3>
                                <i data-feather="plus" class="text-2xl text-primary-500 flex-shrink-0 ml-4 faq-icon"></i>
                            </div>
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Yes, we have expert pediatric neurosurgeons for congenital and acquired brain and spine conditions.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            ...
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Awake brain surgery allows monitoring of brain functions during tumor removal near critical brain areas to preserve neurological functions.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:sticky lg:top-24 h-fit">
                    <div class="bg-gradient-to-br from-primary-50 to-secondary-50 rounded-xl p-6 shadow-lg">
                        ...
                        <p class="text-gray-600 mb-6">Get in touch with our Neurosciences specialists</p>
                        ...
                        <form class="space-y-4">
                            ...
                            <input type="hidden" name="specialty" value="Neurosciences">
