...
<body class="bg-white">
    ...
    <section class="relative h-[50vh] mt-20 overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img src="../assets/specialties/Neuroscience/Neurological-Diagnostics.webp" alt="Neurosciences"
                    ...
                    <div class="fade-in mb-12">
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-2 h-2 bg-primary-500 rounded-full"></div>
                                    <span class="text-gray-700">Modern operating rooms with endoscopes and
                                        microscopes</span>
                                </div>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-2 h-2 bg-primary-500 rounded-full"></div>
                                    <span class="text-gray-700">24/7 emergency neurology and neurosurgery
                                        services</span>
                                </div>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full group"
                            ...
                            <div class="relative overflow-hidden h-48 sm:h-56 shrink-0">
                                <img src="../assets/new-doctors-side/vivek raj.webp"
                                    alt="Dr. Vivek Raj" class="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-300">
                            </div>
                            <div class="p-6">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Neurology/Brai- Stroke-Unit & Seizures.webp"
                            alt="Brain Stroke Unit & Seizures"
                            class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Brain Stroke Unit & Seizures</h3>
                        <p class="text-gray-600 mb-4">Specialized stroke unit with continuous monitoring and seizure
                            control.</p>
                    </div>
                </div>
                ...
                <div
                    class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Neurology/Epilepsy.webp" alt="Epilepsy"
                            class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Epilepsy</h3>
                        <p class="text-gray-600 mb-4">Diagnosis, medical management, and surgical options for seizure
                            disorders.</p>
                    </div>
                </div>
                ...
                <div
                    class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Neurology/Brain & Spine-Tumor-Surgery.webp"
                            alt="Brain & Spine Tumor Surgery"
                            class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                ...
                <div
                    class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Neurology/Movement-Disorders.webp" alt="Movement Disorders"
                            class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">State-of-the-art awake craniotomy for tumor and functional brain
                            surgery.</p>
                    </div>
                </div>
                ...
                <div
                    class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Neurology/Spinal-Cor- Injury.webp" alt="Spinal Cord Injury"
                            class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-8 rounded-xl shadow-md fade-in">
                    ...
                    <p class="text-gray-700 mb-6">Rapid emergency neurological care helped me recover optimal function
                        after a major stroke. Their dedicated stroke unit made all the difference.</p>
                    <div class="bg-green-50 p-4 rounded-lg border border-green-100">
                        <div class="flex items-center space-x-2">
                            <i data-feather="check" class="w-5 h-5 text-green-600"></i>
                            <span class="font-medium text-green-800">Outcome: Regained independence after 3 months
                                rehabilitation.</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-md fade-in">
                    ...
                    <p class="text-gray-700 mb-6">I have been seizure-free after comprehensive medication management and
                        proper monitoring by the neurology team.</p>
                    <div class="bg-green-50 p-4 rounded-lg border border-green-100">
                        <div class="flex items-center space-x-2">
                            <i data-feather="check" class="w-5 h-5 text-green-600"></i>
                            <span class="font-medium text-green-800">Outcome: Improved quality of life and seizure
                                control.</span>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="space-y-4">
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer"
                            onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">How is stroke managed at Raj
                                    Hospitals?</h3>
                                <i data-feather="plus"
                                    class="text-2xl text-primary-500 flex-shrink-0 ml-4 faq-icon"></i>
                            </div>
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>We provide rapid assessment, acute treatment, and multidisciplinary rehabilitation in
                                    our dedicated stroke unit with advanced technologies.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer"
                            onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">Are pediatric neurological
                                    surgeries available?</h3>
                                <i data-feather="plus"
                                    class="text-2xl text-primary-500 flex-shrink-0 ml-4 faq-icon"></i>
                            </div>
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Yes, we have expert pediatric neurosurgeons for congenital and acquired brain and
                                    spine conditions.</p>
                            </div>
                        </div>
