    ...
    <script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    <link rel="canonical" href="https://rajhospitals.com/specialties/obstetrics-and-gynaecology" />
</head>
                    ...
                    <div class="flex flex-col gap-8 overflow-y-auto"
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full group"
                            ...
                            <div class="relative overflow-hidden h-48 sm:h-56 shrink-0">
                                <img src="../assets/Raj-hospital-doctor-image/Raj-hospital-doctor-image/Gyanecologist - Dr. Anupama-Mahli.webp"
                                    alt="Dr. Anupama Mahli" class="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-300">
                            </div>
                            <div class="p-6">
                                ...
                                <a href="../doctors/anupama-mahli.php"
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full group"
                            ...
                            <div class="relative overflow-hidden h-48 sm:h-56 shrink-0">
                                <img src="../assets/doctor-latest/Gyanecologist - Dr. Pushpa Sinha.webp"
                                    alt="Dr. Pushpa Sinha" class="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-300">
                            </div>
                            <div class="p-6">
                                ...
                                <a href="../doctors/pushpa-sinha.php"
                                    class="w-full bg-white text-primary-600 py-2 rounded-lg border border-primary-600 hover:bg-primary-50 transition-colors font-medium flex items-center justify-center space-x-2">
                                    <i data-feather="user" class="w-4 h-4"></i>
                                    <span>View Profile</span>
                                </a>
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full group"
                            ...
                            <div class="p-6">
                                ...
                                <a href="../doctors/tanushree-chakroborty.php"
                                    class="w-full bg-white text-primary-600 py-2 rounded-lg border border-primary-600 hover:bg-primary-50 transition-colors font-medium flex items-center justify-center space-x-2">
                                    <i data-feather="user" class="w-4 h-4"></i>
                                    <span>View Profile</span>
                                </a>
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full group"
                            style="min-height: 500px;">
                            <div class="relative overflow-hidden h-48 sm:h-56 shrink-0">
                                <img src="../assets/doctor-latest/dr-nisha-jha.webp" alt="Dr. Nisha Jha"
                                    class="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-300">
                            </div>
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-gray-900 mb-1">Dr. Nisha Jha</h3>
                                <p class="text-primary-600 font-medium mb-2">MBBS, MS, DNB, FMAS</p>
                                <p class="text-secondary-600 text-sm mb-3">Obstetrics & Gynaecology, Advanced Laparoscopic & Vaginal Surgery, Fetal Medicine, Infertility, PCOS</p>
                                <div class="flex items-center text-sm text-gray-500 mb-4">
                                    <i data-feather="award" class="w-4 h-4 mr-2"></i>
