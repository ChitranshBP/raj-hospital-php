...
<head>
    ...
    <meta name="description" content="Best Hospital in Ranchi for Pregnancy Delivery & Gynecology Care with expert gynecologists for high-risk pregnancy and infertility.">
...
<body class="bg-white">
    ...
    <section class="relative h-[50vh] mt-20 overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img src="../assets/specialties/Obstetrics & Gynaecology/Obstetrics & Gynaecology.webp" alt="Obstetrics & Gynaecology" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 h-full flex items-center">
            <div class="max-w-7xl mx-auto px-4 w-full">
                <div class="max-w-3xl text-white fade-in">
                    ...
                    <p class="text-xl text-gray-200">Best Hospital in Ranchi for Pregnancy Delivery & Gynecology Care with expert gynecologists for high-risk pregnancy and infertility.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="grid lg:grid-cols-3 gap-12">
                ...
                <div class="lg:col-span-2">
                    <div class="fade-in">
                        ...
                        <p class="text-lg text-gray-700 leading-relaxed mb-6">Our Obstetrics & Gynaecology department at Raj Hospitals is dedicated to providing comprehensive care for women at every stage of life. From adolescence to menopause, we offer expert services in maternity care, high-risk pregnancy management, infertility treatment, and minimally invasive gynaecological surgeries. With a team of highly experienced gynaecologists and a patient-centric approach, we ensure the safest delivery experience and best health outcomes for mother and child.</p>
                    ...
                    <div class="flex flex-col gap-8 overflow-y-auto" style="max-height: 1000px; max-width: 340px; margin: 0 auto;">
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full" style="min-height: 500px;">
                            <div class="relative h-48 overflow-hidden">
                                <img src="../assets/Raj-hospital-doctor-image/Raj-hospital-doctor-image/Gynaecologist - Dr. Sobha-Chakraborty.webp" alt="Dr. Shobha Chakraborty" class="w-full h-full object-cover object-top">
                            </div>
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-gray-900 mb-1">Dr. Shobha Chakraborty</h3>
                                <p class="text-primary-600 font-medium mb-2">MD (Obs & Gynae)</p>
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full" style="min-height: 500px;">
                            <div class="relative h-48 overflow-hidden">
                                <img src="../assets/Raj-hospital-doctor-image/Raj-hospital-doctor-image/Gynaecologist - Dr. Sweta-Lal.webp" alt="Dr. Sweta Lal" class="w-full h-full object-cover object-top">
                            </div>
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-gray-900 mb-1">Dr. Sweta Lal</h3>
                                <p class="text-primary-600 font-medium mb-2">MS (Obs & Gynae)</p>
                                <p class="text-secondary-600 text-sm mb-3">Infertility Specialist & Surgeon</p>
                                <div class="flex items-center text-sm text-gray-500 mb-4">
                                    <i data-feather="award" class="w-4 h-4 mr-2"></i>
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full" style="min-height: 500px;">
                            <div class="relative h-48 overflow-hidden">
                                <img src="../assets/Raj-hospital-doctor-image/Raj-hospital-doctor-image/Gynaecologist - Dr. Binit-Priya.webp" alt="Dr. Binit Priya" class="w-full h-full object-cover object-top">
                            </div>
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-gray-900 mb-1">Dr. Binit Priya</h3>
                                <p class="text-primary-600 font-medium mb-2">MS (Obs & Gynae)</p>
                                <p class="text-secondary-600 text-sm mb-3">Gynaecologist & Obstetrician</p>
                                <div class="flex items-center text-sm text-gray-500 mb-4">
                                    <i data-feather="award" class="w-4 h-4 mr-2"></i>
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full" style="min-height: 500px;">
                            <div class="relative h-48 overflow-hidden">
                                <img src="../assets/Raj-hospital-doctor-image/Raj-hospital-doctor-image/Gynaecologist - Dr. Aparna-Jha.webp" alt="Dr. Aparna Jha" class="w-full h-full object-cover object-top">
                            </div>
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-gray-900 mb-1">Dr. Aparna Jha</h3>
                                <p class="text-primary-600 font-medium mb-2">DGO, DNB</p>
                                <p class="text-secondary-600 text-sm mb-3">Gynaecologist</p>
                                <div class="flex items-center text-sm text-gray-500 mb-4">
                                    <i data-feather="award" class="w-4 h-4 mr-2"></i>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Obstetrics & Gynaecology/Gynaec-Laparoscopic-Surgeries.webp" alt="Laparoscopic Surgery" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Gynaec Laparoscopic Surgeries</h3>
                        <p class="text-gray-600 mb-4">Minimally invasive surgeries for ovarian cysts, fibroids, endometriosis, and hysterectomy with faster recovery.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Obstetrics & Gynaecology/High-Risk-Pregnancy.webp" alt="High Risk Pregnancy" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">High Risk Pregnancy</h3>
                        <p class="text-gray-600 mb-4">Specialized care for complicated pregnancies ensuring safety of both mother and baby.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Obstetrics & Gynaecology/Infertility-Treatment_1.webp" alt="Infertility Treatment" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Infertility Treatment</h3>
                        <p class="text-gray-600 mb-4">Advanced fertility solutions including IUI, IVF, and hormonal therapies for couples planning a family.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Obstetrics & Gynaecology/Normal-Delivery.webp" alt="Normal Delivery" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Normal & Painless Delivery</h3>
                        <p class="text-gray-600 mb-4">Promoting natural birth with options for painless labour and epidural analgesia.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Obstetrics & Gynaecology/Caesarean-Section.webp" alt="Caesarean Section" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Caesarean Section (C-Section)</h3>
                        <p class="text-gray-600 mb-4">Safe surgical delivery procedures when necessary, performed by expert obstetricians.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Obstetrics & Gynaecology/Menopause-Clinic.webp" alt="Menopause Clinic" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Menopause Clinic</h3>
                        <p class="text-gray-600 mb-4">Comprehensive care and counselling for menopause related symptoms and health issues.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Obstetrics & Gynaecology/Cancer-Screening.webp" alt="Cancer Screening" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Cancer Screening (Pap Smear & Colposcopy)</h3>
                        <p class="text-gray-600 mb-4">Preventive screening for cervical, uterine, and ovarian cancers for early detection.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Obstetrics & Gynaecology/Family-Planning.webp" alt="Family Planning" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Family Planning Services</h3>
                        <p class="text-gray-600 mb-4">Counselling and provision of various contraceptive methods for family planning.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Obstetrics & Gynaecology/Hysterectomy.webp" alt="Hysterectomy" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Hysterectomy</h3>
                        <p class="text-gray-600 mb-4">Surgical removal of the uterus via laparoscopic, vaginal, or open abdominal methods.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-8 rounded-xl shadow-md fade-in">
                    ...
                    <p class="text-gray-700 mb-6">"I had a complicated pregnancy with high BP. The doctors at Raj Hospitals took exceptional care of me and delivered my healthy baby girl safely."</p>
                ...
                <div class="bg-white p-8 rounded-xl shadow-md fade-in">
                    ...
                    <p class="text-gray-700 mb-6">"After years of trying, we consulted Dr. Sweta Lal. With her expert guidance and treatment, we are now proud parents of twins."</p>
                    <div class="bg-green-50 p-4 rounded-lg border border-green-100">
                        <div class="flex items-center space-x-2">
                            <i data-feather="check" class="w-5 h-5 text-green-600"></i>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">Is painless delivery available at Raj Hospitals?</h3>
                            ...
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Yes, we offer painless normal delivery options such as epidural analgesia for a comfortable birthing experience.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">What services are offered for infertility?</h3>
                                <i data-feather="plus" class="text-2xl text-primary-500 flex-shrink-0 ml-4 faq-icon"></i>
                            </div>
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>We provide comprehensive infertility evaluation, IUI, IVF, hormonal treatment, and laparoscopic fertility enhancing surgeries.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">Do you handle high-risk pregnancies?</h3>
                                <i data-feather="plus" class="text-2xl text-primary-500 flex-shrink-0 ml-4 faq-icon"></i>
                            </div>
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Absolutely. Our hospital is equipped with a NICU and critical care support to manage high-risk pregnancies effectively.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">Is laparoscopic hysterectomy better?</h3>
                                <i data-feather="plus" class="text-2xl text-primary-500 flex-shrink-0 ml-4 faq-icon"></i>
                            </div>
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Laparoscopic hysterectomy is less invasive, involves less pain, smaller scars, and a faster recovery compared to open surgery.</p>
                            </div>
                        </div>
                    </div>
                </div>
