...
<head>
    ...
    <title>Oncology (Cancer Care) - Best Cancer Hospital in Ranchi | Raj Hospitals</title>
    <meta name="description" content="World-class cancer care and radiation oncology services in Ranchi with multi-disciplinary, personalized treatments at Raj Hospitals.">
...
<body class="bg-white">
    ...
    <section class="relative h-[50vh] mt-20 overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img src="../assets/specialties/Oncology/Oncology.webp" alt="Oncology (Cancer Care)" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 h-full flex items-center">
            <div class="max-w-7xl mx-auto px-4 w-full">
                <div class="max-w-3xl text-white fade-in">
                    ...
                    <p class="text-xl text-gray-200">World-class cancer care and radiation oncology services in Ranchi with multi-disciplinary, personalized treatments.</p>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <span class="text-gray-700">Advanced modular operation theaters with ICU and HDU support</span>
                                </div>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-2 h-2 bg-primary-500 rounded-full"></div>
                                    <span class="text-gray-700">State-of-the-art diagnostic imaging including CT, MRI, PET scans</span>
                                </div>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-2 h-2 bg-primary-500 rounded-full"></div>
                                    <span class="text-gray-700">On-site pathology labs with IHC, Cytogenetics, FISH testing</span>
                                </div>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-2 h-2 bg-primary-500 rounded-full"></div>
                                    <span class="text-gray-700">Dedicated chemotherapy infusion center with chemo port facilities</span>
                                </div>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-2 h-2 bg-primary-500 rounded-full"></div>
                                    <span class="text-gray-700">Multidisciplinary oncology team for personalized care</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-8 overflow-y-auto" style="max-height: 1000px; max-width: 340px; margin: 0 auto;">
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full" style="min-height: 500px;">
                            <div class="relative h-48 overflow-hidden">
                                <img src="../assets/Raj-hospital-doctor-image/Raj-hospital-doctor-image/Oncologist - Dr. P-K-Raina.webp" alt="Dr. P K Raina" class="w-full h-full object-cover object-top">
                            </div>
                            <div class="p-6">
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full" style="min-height: 500px;">
                            <div class="relative h-48 overflow-hidden">
                                <img src="../assets/Doc-Side/Dr Anamika Onco photo.webp" alt="Dr. Anamika Kumari" class="w-full h-full object-cover object-top">
                            </div>
                            <div class="p-6">
                                ...
                                <p class="text-secondary-600 text-sm mb-3">Radiotherapy, Head & Neck Oncology, Breast Oncology</p>
                                <div class="flex items-center text-sm text-gray-500 mb-4">
                                    <i data-feather="award" class="w-4 h-4 mr-2"></i>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Oncology/Medical-Oncology.webp" alt="Medical Oncology & Chemotherapy" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Medical Oncology & Chemotherapy</h3>
                        <p class="text-gray-600 mb-4">Safe administration of chemotherapy and advanced drug therapies for various cancers.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Oncology/Surgical-Oncology.webp" alt="Surgical Oncology" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Surgical Oncology</h3>
                        <p class="text-gray-600 mb-4">Expert surgeries for cancer including head & neck, breast, lung, abdominal cancers, and more.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Oncology/Head & Neck-Cancer.webp" alt="Head & Neck Cancer Treatment" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Head & Neck Cancer Treatment</h3>
                        <p class="text-gray-600 mb-4">Specialized surgical and non-surgical treatments targeting cancers of the head and neck region.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Oncology/breast-cancer.webp" alt="Breast Cancer Treatment" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Breast Cancer Treatment</h3>
                        <p class="text-gray-600 mb-4">Comprehensive care involving breast conservative surgery, reconstruction, and medical therapies.</p>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Oncology/Gynaecologic-Oncology.webp" alt="Gynaecologic Oncology" class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Gynaecologic Oncology</h3>
                        <p class="text-gray-600 mb-4">Treatment for cancers of female reproductive organs including radical hysterectomy and ovarian surgery.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-8 rounded-xl shadow-md fade-in">
                    ...
                    <p class="text-gray-700 mb-6">Received comprehensive combined surgery and radiotherapy leading to successful remission. The entire care team was supportive and professional.</p>
                    <div class="bg-green-50 p-4 rounded-lg border border-green-100">
                        <div class="flex items-center space-x-2">
                            <i data-feather="check" class="w-5 h-5 text-green-600"></i>
                            <span class="font-medium text-green-800">Outcome: Complete remission with excellent quality of life.</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-md fade-in">
                    ...
                    <p class="text-gray-700 mb-6">Underwent breast conservation surgery with oncoplastic reconstruction and chemotherapy. Excellent recovery and follow-up care.</p>
                    <div class="bg-green-50 p-4 rounded-lg border border-green-100">
                        <div class="flex items-center space-x-2">
                            <i data-feather="check" class="w-5 h-5 text-green-600"></i>
                            <span class="font-medium text-green-800">Outcome: Healthy and cancer-free after 5 years.</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">What types of cancer are treated?</h3>
                            ...
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>We treat all solid organ malignancies including breast, head & neck, lung, gastrointestinal, gynecologic, and urologic cancers.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">What treatments do you provide?</h3>
                                <i data-feather="plus" class="text-2xl text-primary-500 flex-shrink-0 ml-4 faq-icon"></i>
                            </div>
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Our comprehensive options include surgery, chemotherapy, radiation therapy, immunotherapy, and targeted therapies.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            ...
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Yes, including pain management, nutritional counseling, psychological support, and palliative care.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer" onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">Is personalized treatment available?</h3>
                                <i data-feather="plus" class="text-2xl text-primary-500 flex-shrink-0 ml-4 faq-icon"></i>
                            </div>
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Yes, every patient receives an individualized treatment plan from a multidisciplinary oncology team.</p>
                            </div>
                        </div>
                    </div>
                </div>
