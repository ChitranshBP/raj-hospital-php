    ...
    <script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    <link rel="canonical" href="https://rajhospitals.com/specialties/aesthetic-and-reconstructive-surgery" />
</head>
                    ...
                    <div class="fade-in">
                        ...
                        <div class="bg-primary-50 p-6 rounded-xl border border-primary-100 mb-8">
                            <h3 class="text-xl font-semibold text-gray-900 mb-4 flex items-center">
                                ...
                                Why Choose Our Aesthetic & Reconstructive Surgery Department
                            </h3>
                            <ul class="space-y-3">
                    ...
                    <div class="fade-in mb-12">
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-2 h-2 bg-primary-500 rounded-full"></div>
                                    <span class="text-gray-700">Well-equipped aesthetic recovery units</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-8 overflow-y-auto"
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full group"
                            ...
                            <div class="p-6">
                                ...
                                <a href="../doctors/pankaj-kumar.php"
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Jaw, cheek, and chin implants to balance facial aesthetics.</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Enhancement procedures to improve lip shape and volume.</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Advanced hair transplantation and restoration techniques.</p>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Surgical fat removal for body shaping and sculpting.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-8 bg-gradient-to-r from-gray-50 to-blue-50">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-12 fade-in">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Common conditions we diagnose and treat in our Aesthetic & Reconstructive Surgery department
                </p>
            </div>
            ...
            <div class="bg-white rounded-xl p-8 shadow-sm border border-gray-100 fade-in">
                <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-4">
                    <div class="flex items-center space-x-3 py-2">
                        ...
                        <span class="text-gray-700 text-base">Cleft Lip & Palate Repair</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Burn Reconstruction</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Scar Revision & Management</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Facial Trauma Reconstruction</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Breast Reconstruction</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Hand Surgery & Reconstruction</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Congenital Deformity Correction</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Post-Accident Reconstructive Surgery</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Rhinoplasty (Nose Reshaping)</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Facial Aesthetic Procedures</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Body Contouring</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Hair Transplantation</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Skin Grafting</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Microvascular Surgery</span>
                    </div>
                    <div class="flex items-center space-x-3 py-2">
                        <div class="w-2 h-2 bg-primary-500 rounded-full flex-shrink-0"></div>
                        <span class="text-gray-700 text-base">Craniofacial Surgery</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-8 bg-gradient-to-br from-primary-50 to-secondary-50">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-12 fade-in">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Real stories of healing and recovery from our Aesthetic & Reconstructive Surgery department
                </p>
            </div>
    ...
    <section class="py-8 bg-white">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Common questions about Aesthetic & Reconstructive Surgery conditions and treatments
                </p>
            </div>
