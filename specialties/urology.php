    ...
    <script type="application/ld+json">
{
  ...
  "mainEntity": [
    ...
    <link rel="canonical" href="https://rajhospitals.com/specialties/urology" />
</head>
...
<body class="bg-white">
    ...
    <section class="relative h-[50vh] mt-20 overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img src="../assets/specialties/Urology/Urology.webp" alt="Urology" class="w-full h-full object-cover">
                    ...
                    <div class="fade-in mb-12">
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-2 h-2 bg-primary-500 rounded-full"></div>
                                    <span class="text-gray-700">Robotic surgical system for precision treatments</span>
                                </div>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                    ...
                    <div class="flex flex-col gap-8 overflow-y-auto"
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full group"
                            ...
                            <div class="p-6">
                                ...
                                <p class="text-primary-600 font-medium mb-2">MBBS, MS, MCh (Urology)</p>
                                <p class="text-secondary-600 text-sm mb-3">Urology & Surgical Oncology</p>
                                ...
                                <a href="../doctors/sunil-kumar.php"
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full group"
                            ...
                            <div class="p-6">
                                ...
                                <p class="text-primary-600 font-medium mb-2">MBBS, MS, MCh (Urology)</p>
                                <p class="text-secondary-600 text-sm mb-3">Urology</p>
                                <div class="flex items-center text-sm text-gray-500 mb-4">
                                    <i data-feather="award" class="w-4 h-4 mr-2"></i>
                                    <span>18+ Years Experience</span>
                                </div>
                                ...
                                <a href="../doctors/ved-prakash.php"
                                    class="w-full bg-white text-primary-600 py-2 rounded-lg border border-primary-600 hover:bg-primary-50 transition-colors font-medium flex items-center justify-center space-x-2">
                                    <i data-feather="user" class="w-4 h-4"></i>
                                    <span>View Profile</span>
                                </a>
    ...
    <section class="py-8 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-12 fade-in">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Advanced treatments for all urological conditions
                </p>
            </div>
    ...
    <section class="py-8 bg-gradient-to-br from-primary-50 to-secondary-50">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-12 fade-in">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Real stories of successful urological treatments
                </p>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 fade-in">
                ...
                <div class="bg-white rounded-xl shadow-md overflow-hidden">
                    <iframe class="w-full aspect-video" src="https://www.youtube.com/embed/2SgBfniF4nY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    <div class="p-4">
                        <h3 class="text-lg font-semibold text-gray-900 line-clamp-2">छोटे Kidney Stone को बाहर कैसे निकले</h3>
                    </div>
                </div>

                <div class="bg-white rounded-xl shadow-md overflow-hidden">
                    <iframe class="w-full aspect-video" src="https://www.youtube.com/embed/zEN_ziZWeII" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    <div class="p-4">
                        <h3 class="text-lg font-semibold text-gray-900 line-clamp-2">Urinary Tract Infection ( UTI )</h3>
                    </div>
                </div>

                <div class="bg-white rounded-xl shadow-md overflow-hidden">
                    <iframe class="w-full aspect-video" src="https://www.youtube.com/embed/olkjuMsFaHw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    <div class="p-4">
                        <h3 class="text-lg font-semibold text-gray-900 line-clamp-2">Varicocelectomy Surgery Explained</h3>
                    </div>
                </div>
    ...
    <section class="py-8 bg-white">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-12">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Common questions about urology and kidney health
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="lg:sticky lg:top-24 h-fit">
                    <div class="bg-gradient-to-br from-primary-50 to-secondary-50 rounded-xl p-6 shadow-lg">
                        ...
                        <p class="text-gray-600 mb-6">Get in touch with our Urology specialists</p>
