...
<head>
    ...
    <title>Minimal Access Surgery in Ranchi | Best Laparoscopic Surgery Hospital in Ranchi – Raj Hospital</title>

    <meta name="description"
        content="Raj Hospital offers advanced minimal access and laparoscopic surgery in Ranchi with experienced surgeons, modern operation theatres and faster recovery." />
    ...
    <!--
Primary Keyword:
Minimal Access Surgery in Ranchi

Secondary Keywords:
Best Laparoscopic Surgery Hospital in Ranchi
Laparoscopic Surgeon in Ranchi
Keyhole Surgery in Ranchi
Minimally Invasive Surgery in Jharkhand
-->
    ...
    <script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Which is the best hospital for minimal access surgery in Ranchi?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Raj Hospital is one of the best hospitals in Ranchi for minimal access and laparoscopic surgery."
      }
    },
    {
      "@type": "Question",
      "name": "Is laparoscopic surgery safe at Raj Hospital?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, minimal access and laparoscopic surgeries at Raj Hospital are performed using advanced techniques with high safety standards."
      }
    }
  ]
}
    ...
    <link rel="canonical" href="https://rajhospitals.com/specialties/minimal-access-surgery" />
</head>
...
<body class="bg-white">
    ...
    <section class="relative h-[50vh] mt-20 overflow-hidden">
        ...
        <div class="absolute inset-0">
            <img src="../assets/specialties/Minimal Access Surgery/Minimal-Access-Surgery.webp"
                alt="Minimal Access Surgery" class="w-full h-full object-cover">
        ...
        <div class="relative z-10 h-full flex items-center">
            <div class="max-w-7xl mx-auto px-4 w-full">
                <div class="max-w-3xl text-white fade-in">
                    ...
                    <p class="text-xl text-gray-200">Advanced laparoscopic, laser, and general surgery with highly
                        skilled surgeons and comprehensive care in Ranchi.</p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="lg:col-span-2">
                    <div class="fade-in">
                        ...
                        <p class="text-lg text-gray-700 leading-relaxed mb-6">The Department of General and Minimally
                            Invasive Surgery at Raj Hospitals offers complete evaluation, diagnosis, and surgical
                            treatment for a wide range of disorders. Our surgeons provide state-of-the-art patient care,
                            using minimally invasive and laser techniques for improved recovery and outcomes. We
                            specialize in abdominal, breast, skin, hernia, and soft tissue surgeries, delivering
                            personalized care and excellent results. ICU and emergency services ensure patients receive
                            the highest level of surgical care, with a multidisciplinary team approach.</p>
                        ...
                        <div class="grid md:grid-cols-2 gap-4">
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <span class="text-gray-700">Advanced operation theatres with state-of-the-art
                                        equipment</span>
                                </div>
                            </div>
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-2 h-2 bg-primary-500 rounded-full"></div>
                                    <span class="text-gray-700">Integrated surgical team and multidisciplinary
                                        approach</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col gap-8 overflow-y-auto"
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full group"
                            ...
                            <div class="p-6">
                                ...
                                <a href="../doctors/ashish-modi.php"
                        ...
                        <div class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 w-full group"
                            ...
                            <div class="relative overflow-hidden h-48 sm:h-56 shrink-0">
                                <img src="../assets/doc-dummy/male-dummy-raj.webp"
                                    alt="Dr. B Kumar" class="w-full h-full object-cover object-top group-hover:scale-105 transition-transform duration-300">
                            </div>
                            <div class="p-6">
                                <h3 class="text-xl font-bold text-gray-900 mb-1">Dr. B Kumar</h3>
                                <p class="text-primary-600 font-medium mb-2">MBBS, MS</p>
                                <p class="text-secondary-600 text-sm mb-3">Minimal Access Surgery</p>
                                <div class="flex items-center text-sm text-gray-500 mb-4">
                                    <i data-feather="award" class="w-4 h-4 mr-2"></i>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div
                    ...
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Minimal Access Surgery/Laparoscopic & Laser-Surgery.webp"
                            alt="Laparoscopic & Laser Surgery"
                            class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Laparoscopic & Laser Surgery</h3>
                        <p class="text-gray-600 mb-4">Gall Bladder, Hernia, Appendix & advanced general surgery using
                            minimal access and laser technology.</p>
                    </div>
                </div>
                ...
                <div
                    class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Minimal Access Surgery/Thoracoscopic.webp"
                            alt="Thoracoscopic (Lung) Surgeries"
                            class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Thoracoscopic (Lung) Surgeries</h3>
                        <p class="text-gray-600 mb-4">Minimally invasive surgical management of chest and lung
                            conditions.</p>
                    </div>
                </div>
                ...
                <div
                    class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Minimal Access Surgery/Bariatric.webp"
                            alt="Bariatric (Weight Loss) & GI Surgeries"
                            class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Bariatric (Weight Loss) & GI Surgeries</h3>
                        <p class="text-gray-600 mb-4">Weight-loss and gastrointestinal surgeries for obesity and
                ...
                <div
                    class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Minimal Access Surgery/Laser-Proctology-Indian.webp"
                            alt="Laser Surgery For Proctology"
                            class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Laser Surgery For Proctology</h3>
                        <p class="text-gray-600 mb-4">Painless, advanced treatment for fissures, fistulas, piles, and
                            hemorrhoids using laser.</p>
                    </div>
                </div>
                ...
                <div
                    class="bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden fade-in">
                    <div class="h-48 overflow-hidden">
                        <img src="../assets/specialties/Minimal Access Surgery/Diagnostic-and-Therapeutic-Endoscopy.webp"
                            alt="Diagnostic and Therapeutic Endoscopy"
                            class="w-full h-full object-cover hover:scale-105 transition-transform duration-300">
                    </div>
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-gray-900 mb-3">Diagnostic and Therapeutic Endoscopy</h3>
                        <p class="text-gray-600 mb-4">Procedures for both diagnosis and treatment using advanced
                            endoscopic techniques.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div class="bg-white p-8 rounded-xl shadow-md fade-in">
                    ...
                    <p class="text-gray-700 mb-6">I underwent surgery for a complicated abdominal wall problem at Raj
                        Hospitals. The surgeon's laparoscopic skill and the care I received resulted in a quick and
                        satisfying recovery.</p>
                    <div class="bg-green-50 p-4 rounded-lg border border-green-100">
                        <div class="flex items-center space-x-2">
                            <i data-feather="check" class="w-5 h-5 text-green-600"></i>
                            <span class="font-medium text-green-800">Outcome: Full recovery post-laparoscopic
                                repair.</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-md fade-in">
                    ...
                    <p class="text-gray-700 mb-6">I was facing gallbladder stones and the Raj Hospitals surgical team
                        treated me so well and performed the surgery efficiently. The team is fantastic.</p>
                    <div class="bg-green-50 p-4 rounded-lg border border-green-100">
                        <div class="flex items-center space-x-2">
                            <i data-feather="check" class="w-5 h-5 text-green-600"></i>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer"
                            ...
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">How long after surgery can you go
                                    home?</h3>
                                <i data-feather="plus"
                            ...
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Most patients are observed in the recovery room for 45 minutes to 2 hours
                                    post-surgery, and can usually go home between 1 and 4 hours after outpatient
                                    surgery.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer"
                            onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">What are minimally
                                    invasive/laparoscopic surgeries?</h3>
                                <i data-feather="plus"
                                    class="text-2xl text-primary-500 flex-shrink-0 ml-4 faq-icon"></i>
                            </div>
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Laparoscopic surgeries use small cuts, a camera, and fine instruments for surgery
                                    inside your body, allowing quicker recovery, less pain and smaller scars compared to
                                    open surgery.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer"
                            ...
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Laser surgeries for hemorrhoids, fistulas etc. are usually painless and offer faster
                                    healing as compared to traditional procedures.</p>
                            </div>
                        </div>
                        ...
                        <div class="faq-item bg-gray-50 rounded-xl p-6 hover:shadow-md transition-shadow cursor-pointer"
                            onclick="toggleFaq(this)">
                            <div class="flex justify-between items-center">
                                <h3 class="text-lg font-semibold text-gray-900 mb-3">Can all hernias be treated
                                    laparoscopically?</h3>
                                <i data-feather="plus"
                                    class="text-2xl text-primary-500 flex-shrink-0 ml-4 faq-icon"></i>
                            </div>
                            <div class="faq-content text-gray-700 transition-all duration-300 overflow-hidden max-h-0">
                                <p>Most hernias can be repaired using laparoscopy, but some complex or recurrent hernias
                                    might need open surgery depending on individual evaluation.</p>
                            </div>
                        </div>
                    </div>
                </div>
