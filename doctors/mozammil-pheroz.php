...
<head>
    ...
    <link rel="canonical" href="https://rajhospitals.com/doctors/mozammil-pheroz" />
</head>
...
<script type="application/ld+json">
{
    ...
    <script>
        ...
        const doctorData = {
            ...
            education: [
                { degree: 'MS (Orthopaedics)', institution: 'VMMC & Safdarjung Hospital, New Delhi', year: '' },
                { degree: 'DNB (Orthopaedics)', institution: 'VMMC & CIO Safdarjung, New Delhi', year: '' },
                { degree: 'MBBS', institution: 'Patna Medical College and Hospital (PMCH)', year: '' },
                { degree: 'Dip Sports Medicine', institution: 'FIFA, Switzerland', year: '' }
            ],
            memberships: [
            ...
            publications: [
                { title: 'Research Publications in National & International Orthopaedic Journals', journal: 'Various Indexed Journals', year: '' },
                { title: 'Highly Cited Orthopaedic Research Papers', journal: 'Google Scholar Indexed', year: '' }
            ],
            contact: {
                phone: '+919263630500'
            }
