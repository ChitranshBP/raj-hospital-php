...
<head>
    ...
    <link rel="canonical" href="https://rajhospitals.com/doctors/saurabh-kumar" />
</head>
    ...
    <script>
        ...
        const doctorData = {
            ...
            education: [
                ...
                { degree: 'Senior Residency (Anaesthesiology)', institution: 'JIPMER, Pondicherry', year: '' },
                { degree: 'Senior Residency (Critical Care)', institution: 'JIPMER, Pondicherry', year: '' },
                { degree: 'Senior Residency (Anaesthesiology - Critical Care)', institution: 'JIPMER, Pondicherry', year: '' }
            ],
            memberships: [
                'IMA Association of Bihar for starting Critical Care in Patna'
            ],
            contact: {
                phone: '+919263630500'
            }
                    ...
                    <div class="max-w-7xl mx-auto px-4">
                        <div class="md:flex md:items-start md:gap-12">
                             ...
                             <div class="md:flex-1 space-y-8">
                                ...
                                <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                                    <h2 class="text-2xl font-bold text-gray-900 mb-6 border-b border-gray-100 pb-2">Areas of Interest</h2>
                                ...
                                <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                                    <h2 class="text-2xl font-bold text-gray-900 mb-6 border-b border-gray-100 pb-2">Awards / Memberships / Positions</h2>
                                    <div class="space-y-3">
