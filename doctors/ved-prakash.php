...
<script type="application/ld+json">
{
    ...
    <script>
        ...
        const doctorData = {
            ...
            education: [
                { degree: 'MS (General Surgery)', institution: 'UCMS & GTB Hospital, Delhi', year: '' },
                { degree: 'MBBS', institution: 'MAMC, New Delhi', year: '' },
                { degree: 'MCh (Urology)', institution: 'KGMU, Lucknow', year: '' }
            ],
            memberships: [
