...
<head>
    ...
    <title>Dr. Abhijit Kumar | Raj Hospitals</title>
...
<body class="bg-gray-50">
    ...
    <script>
        ...
        const doctorData = {
            ...
            education: [
                { degree: 'PDCC (Head and Neck Oncology)', institution: 'Tata Memorial Centre, Mumbai', year: '2010-11' },
                { degree: 'MS (Otolaryngology)', institution: 'Kasturba Medical College, Mangalore, Manipal University', year: '2004-2006' },
                { degree: 'MBBS', institution: 'Government Medical College, Thiruvananthapuram, Kerala University', year: '2000-2001' }
            ],
            memberships: [
            ...
            publications: [
                { title: 'Myoparasitism: A Rare Differential in a Case of Parotid Swelling', journal: 'J Head Neck Spine Surg', year: '2021' },
                { title: 'Aggressive Invasive Fungal Sinusitis with MDR Pseudomonas co-infection', journal: 'Int J Otorhinolaryngol Head Neck Surg', year: '2021' },
                { title: 'Bilateral Central Retinal Artery Occlusion in Post-COVID Mucormycosis', journal: 'Cureus', year: '2021' },
                { title: 'Berry-Treacher Collins Syndrome with Congenital Bells Palsy', journal: 'Cureus', year: '2021' },
                // ... truncated list, keeping important ones
                { title: 'The Role of Oral Vitamin D3 in Chronic Rhinosinusitis', journal: 'J Family Med Prim Care', year: '2020' },
                { title: 'Sphenopalatine Ganglion Block in Endoscopic Sinus Surgery: A Comparative Study', journal: 'J Allergy Ther', year: '2020' },
                { title: 'Osteomyelitis of the Temporal Bone: Terminology, Diagnosis, and Management', journal: 'J Neurol Surg B Skull Base', year: '2014' },
                { title: 'Management of Head and Neck Trauma in a Developing Country', journal: 'Indian J Otolaryngol Head Neck Surg', year: '2009' }
            ],
            contact: {
                phone: '+919263630500'
            }
                    ...
                    <div class="max-w-7xl mx-auto px-4">
                        <div class="md:flex md:items-start md:gap-12">
                             ...
                             <div class="md:flex-1 space-y-8">
                                ...
                                <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                                    <h2 class="text-2xl font-bold text-gray-900 mb-6 border-b border-gray-100 pb-2">Professional Memberships</h2>
                                    <ul class="list-disc list-inside space-y-2 text-gray-700">
                                        ${doctor.memberships.map(member => `<li>${member}</li>`).join('')}
                                    </ul>
                                </div>` : ''}
                                ...
                                <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                                    <h2 class="text-2xl font-bold text-gray-900 mb-6 border-b border-gray-100 pb-2">Research & Publications</h2>
                                    <div class="space-y-4">
                                        ${doctor.publications.map(pub => `
                                            <div class="p-4 bg-gray-50 rounded-lg">
                                                <h4 class="font-bold text-gray-900">${pub.title}</h4>
                                                ${pub.journal ? `<p class="text-primary-600 text-sm mt-1">${pub.journal} ${pub.year ? `(${pub.year})` : ''}</p>` : ''}
                                            </div>
                                        `).join('')}
                                    </div>
                                </div>` : ''}
