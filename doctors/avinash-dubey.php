...
<head>
    ...
    <link rel="canonical" href="https://rajhospitals.com/doctors/avinash-dubey" />
</head>
                    ...
                    <div class="max-w-7xl mx-auto px-4">
                        <div class="md:flex md:items-start md:gap-12">
                             ...
                             <div class="md:flex-1 space-y-8">
                                ...
                                <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 mt-6 md:mt-0">
                                    <h2 class="text-2xl font-bold text-gray-900 mb-6 border-b border-gray-100 pb-2">Awards & Recognition</h2>
                                    <ul class="space-y-4">
                                        ${doctor.awards.map(award => `
                                            <li class="flex items-start space-x-3">
                                                <i data-feather="award" class="w-5 h-5 text-primary-500 mt-0.5"></i>
                                                <div>
                                                    <p class="font-medium text-gray-900">${award.title}</p>
                                                    ${award.organization ? `<p class="text-sm text-gray-600">${award.organization}</p>` : ''}
                                                    ${award.year ? `<p class="text-xs text-gray-500">${award.year}</p>` : ''}
                                                </div>
                                            </li>
                                        `).join('')}
                                    </ul>
