...
<head>
    ...
    <link rel="canonical" href="https://rajhospitals.com/doctors/ashish-basant" />
</head>
    ...
    <script>
        ...
        const doctorData = {
            ...
            expertise: [
                ...
                'Preterm and Low Birth Weight Baby Care'
            ],
            education: [
                { degree: 'MBBS', institution: '', year: '' },
                { degree: 'MD (Pediatrics)', institution: 'JLNMCH Bhagalpur, AKU Patna', year: '' }
            ],
            memberships: [
                'MIAP',
                'MIMA',
