...
<head>
    ...
    <title>Is Heart Attack Genetic? - Hereditary Heart Risk Guide | RAJ Hospital Ranchi</title>
    <meta name="description" content="Is heart attack genetic? जानें heart disease की hereditary risk, family history का effect, और prevention strategies। Genetic heart risk guide।">
    <meta name="keywords" content="heart attack genetic, hereditary heart disease, family history heart attack, genetic heart risk">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://rajhospitals.com/blog/is-heart-attack-genetic.php">

    <meta property="og:title" content="Is Heart Attack Genetic? - Hereditary Heart Risk Guide">
    <meta property="og:description" content="Is heart attack genetic? जानें heart disease की hereditary risk।">
    ...
    <script type="application/ld+json">
{
    ...
    "mainEntity": [
        {
            "@type": "Question",
            "name": "Is Heart Attack Genetic? - Hereditary Heart Risk Guide में डॉक्टर को कब दिखाना चाहिए?",
            "acceptedAnswer": {
                "@type": "Answer",
        ...
        {
            "@type": "Question",
            "name": "क्या Is Heart Attack Genetic? - Hereditary Heart Risk Guide दूसरी स्वास्थ्य समस्याओं से जुड़ा हो सकता है?",
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "हां, कई लक्षण अलग-अलग बीमारियों में मिलते-जुलते हो सकते हैं। इसलिए Heart Attack Se Kaise Bachen: 15 Powerful Tips for a Healthy Heart जैसे संबंधित विषयों को समझना उपयोगी है। जरूरत के अनुसार डॉक्टर जांच, ब्लड टेस्ट, इमेजिंग, ईसीजी या विशेषज्ञ परामर्श की सलाह दे सकते हैं।"
            }
        },
        {
            "@type": "Question",
    ...
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "MedicalWebPage",
        "headline": "Is Heart Attack Genetic? - Hereditary Heart Risk Guide | RAJ Hospital Ranchi",
        "description": "Is heart attack genetic? जानें heart disease की hereditary risk, family history का effect, और prevention strategies। Genetic heart risk guide।",
        "url": "https://rajhospitals.com/blog/is-heart-attack-genetic.php",
        "image": "https://rajhospitals.com/blog/assets/img/featured/is-heart-attack-genetic.png",
        "author": {
            "@type": "Organization",
    ...
    <script type="application/ld+json">
    {
        ...
        "itemListElement": [
            ...
            },
            {
                "@type": "ListItem",
                "position": 3,
                "name": "Is Heart Attack Genetic? - Hereditary Heart Risk Guide | RAJ Hospital Ranchi"
            }
        ]
    }
    </script>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 py-4 text-sm mt-[120px]">
        <nav class="text-gray-500">
            ...
            <span class="mx-2">›</span>
            <span class="text-gray-700">Heart Attack Genetic Guide</span>
        </nav>
    </div>
    ...
    <main class="max-w-4xl mx-auto px-4 pb-12">
        <article class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="aspect-[16/9] md:aspect-[21/9] w-full overflow-hidden bg-gray-50 flex items-center justify-center">
                <img src="assets/img/featured/is-heart-attack-genetic.png" alt="Is Heart Attack Genetic - Hereditary Heart Risk Guide" class="w-full h-full object-contain">
            </div>

            <!-- Hero Header -->
            <div class="p-6 md:p-10 border-b border-gray-100">
                <span class="inline-block bg-red-600 text-white text-xs font-semibold px-3 py-1 rounded-full mb-4">Cardiology</span>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-800 mb-4">Is Heart Attack Genetic? - Hereditary Heart Risk Guide</h1>
            ...
            <div class="p-6 md:p-10">
                ...
                <p class="text-lg leading-relaxed text-gray-700 mb-6">
                    <strong>Is heart attack genetic?</strong> - यह एक important question है जो उन लोगों में common है जिनके family में heart disease का history है। Genetics definitely heart attack risk को affect करता है, लेकिन यह deterministic नहीं है।
                </p>

                <div class="raj-callout raj-callout-danger">
                    <strong class="text-red-700">Key Insight:</strong>
                    <span class="text-gray-700"> <strong>Genetics risk factor है, not destiny।</strong> Lifestyle changes से genetic risk को significantly कम किया जा सकता है।</span>
                </div>

                <!-- Section 1: Genetics and Heart Disease -->
                <h2 class="text-xl font-bold text-gray-800 border-b-2 border-red-600 pb-2 mt-8 mb-4">Genetics और Heart Disease का Connection</h2>

                <p class="text-gray-700 mb-4">
                    Heart disease में genetics का role complex है। कुछ genes directly heart attack risk बढ़ाते हैं, जबकि अन्य risk को indirectly affect करते हैं:
                </p>

                <div class="space-y-4 mb-6">
                    <div class="bg-gray-50 p-4 rounded-lg border-l-4 border-red-600">
                        <h4 class="font-bold text-red-600">1. Inherited Conditions</h4>
                        <p class="text-sm text-gray-600">Familial hypercholesterolemia, hypertrophic cardiomyopathy जैसी conditions जो genes से pass होती हैं।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border-l-4 border-red-600">
                        <h4 class="font-bold text-red-600">2. Polygenic Risk</h4>
                        <p class="text-sm text-gray-600">Multiple genes collectively heart risk को affect करते हैं - कोई single gene नहीं।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border-l-4 border-red-600">
                        <h4 class="font-bold text-red-600">3. Gene-Environment Interaction</h4>
                        <p class="text-sm text-gray-600">Genes lifestyle choices के साथ interact करते हैं - poor lifestyle genetic risk को amplify करती है।</p>
                    </div>
                </div>

                <!-- Section 2: Family History Risk -->
                <h2 class="text-xl font-bold text-gray-800 border-b-2 border-red-600 pb-2 mt-8 mb-4">Family History कितना Important है?</h2>

                <div class="overflow-x-auto mb-6">
                    <table class="w-full text-sm">
                        <thead class="bg-red-100">
                            <tr>
                                <th class="p-3 text-left">Family History</th>
                                <th class="p-3 text-left">Risk Level</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-200">
                            <tr>
                                <td class="p-3 font-medium">No family history</td>
                                <td class="p-3">Baseline risk</td>
                            </tr>
                            <tr class="bg-gray-50">
                                <td class="p-3 font-medium">One parent with heart disease (before 55 for men, 65 for women)</td>
                                <td class="p-3">2x increased risk</td>
                            </tr>
                            <tr>
                                <td class="p-3 font-medium">Both parents with heart disease</td>
                                <td class="p-3">4x increased risk</td>
                            </tr>
                            <tr class="bg-gray-50">
                                <td class="p-3 font-medium">Sibling with heart disease</td>
                                <td class="p-3">2x increased risk</td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <h2 class="text-xl font-bold text-gray-800 border-b-2 border-red-600 pb-2 mt-8 mb-4">अगर Family History है तो क्या करें?</h2>

                <div class="grid grid-cols-2 gap-4 mb-6">
                    <div class="bg-green-50 p-4 rounded-lg">
                        <h4 class="font-bold text-green-600">1. Get Screened Early</h4>
                        <p class="text-sm text-gray-600">30 की उम्र से regular cardiac checkups करवाएं। Lipid profile, BP, और ECG ज़रूरी।</p>
                    </div>
                    <div class="bg-green-50 p-4 rounded-lg">
                        <h4 class="font-bold text-green-600">2. Know Your Numbers</h4>
                        <p class="text-sm text-gray-600">Cholesterol, BP, blood sugar, BMI - इनको control में रखें।</p>
                    </div>
                    <div class="bg-green-50 p-4 rounded-lg">
                        <h4 class="font-bold text-green-600">3. Adopt Heart-Healthy Lifestyle</h4>
                        <p class="text-sm text-gray-600">Exercise, balanced diet, no smoking, limited alcohol।</p>
                    </div>
                    <div class="bg-green-50 p-4 rounded-lg">
                        <h4 class="font-bold text-green-600">4. Consider Genetic Testing</h4>
                        <p class="text-sm text-gray-600">अगर strong family history है, तो genetic counselor से बात करें।</p>
                    </div>
                </div>

                <!-- Section 4: Prevention -->
                <h2 class="text-xl font-bold text-gray-800 border-b-2 border-red-600 pb-2 mt-8 mb-4">Genetic Risk को कैसे Reduce करें?</h2>

                <ul class="list-disc list-inside space-y-2 text-gray-700 mb-6">
                    <li><strong>Regular Exercise:</strong> 150 min/week moderate activity</li>
                    <li><strong>Heart-Healthy Diet:</strong> Fruits, vegetables, whole grains, lean proteins</li>
                    <li><strong>Maintain Healthy Weight:</strong> BMI 18.5-24.9 रखें</li>
                    <li><strong>Control BP और Cholesterol:</strong> Regular monitoring और medication if needed</li>
                    <li><strong>Quit Smoking:</strong> Smoking genetic risk को amplify करती है</li>
                    <li><strong>Manage Stress:</strong> Chronic stress inflammation बढ़ाता है</li>
                </ul>

                <!-- CTA Box -->
                <div class="bg-gradient-to-r from-red-600 to-red-700 text-white p-6 rounded-xl text-center mb-8">
                    <h3 class="text-xl font-bold mb-2">Know Your Heart Risk</h3>
                    <p class="opacity-90 mb-4">RAJ Hospital Ranchi में comprehensive cardiac screening और genetic counseling available है।</p>
                    <a href="<?php echo $base_url; ?>contact.php" class="inline-block bg-white text-red-600 font-bold px-6 py-2 rounded-lg hover:bg-gray-100 transition-colors">Book Cardiac Checkup</a>
                </div>

                <!-- FAQs -->
                <h2 class="text-xl font-bold text-gray-800 border-b-2 border-red-600 pb-2 mt-8 mb-4">FAQs - Common Questions</h2>

                <div class="space-y-4">
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-bold text-red-600 mb-2">अगर मेरे parents को heart attack हुआ, क्या मुझे definitely होगा?</h4>
                        <p class="text-gray-700">नहीं। Family history risk बढ़ाती है, लेकिन lifestyle changes से risk को significantly कम किया जा सकता है।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-bold text-red-600 mb-2">क्या children को heart attack की risk pass होती है?</h4>
                        <p class="text-gray-700">कुछ inherited conditions जैसे familial hypercholesterolemia pass हो सकते हैं। Genetic testing से पता चल सकता है।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-bold text-red-600 mb-2">क्या genetic testing necessary है?</h4>
                        <p class="text-gray-700">सिर्फ strong family history (multiple relatives with early heart disease) हो तो। otherwise lifestyle focus ज़्यादा important है।</p>
                    </div>
                </div>
                <!-- RAJ SEO ENHANCEMENT START -->
                <section class="mt-10 bg-blue-50 border border-blue-100 rounded-xl p-5">
                    <h2 class="text-xl font-bold text-gray-800 mb-4">Is Heart Attack Genetic? - Hereditary Heart Risk Guide पर डॉक्टर की सलाह</h2>
                    <p class="text-gray-700 mb-4">Is heart attack genetic? जानें heart disease की hereditary risk, family history का effect, और prevention strategies। Genetic heart risk guide।</p>
                    <p class="text-gray-700 mb-4">रांची और आसपास के मरीजों के लिए सबसे जरूरी बात यह है कि लक्षणों को सही medical context में समझा जाए। Is Heart Attack Genetic? - Hereditary Heart Risk Guide शुरुआत में सामान्य लग सकता है, लेकिन इसका कारण lifestyle, infection, hormone imbalance, पुरानी बीमारी, medicine side effect या किसी गंभीर condition से जुड़ा हो सकता है। सही history, physical examination और जरूरत के अनुसार जांच से डॉक्टर यह तय कर पाते हैं कि emergency care, दवा, lifestyle correction, observation या specialist consultation में से क्या जरूरी है।</p>
                ...
                <section class="mt-8">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                        <h3 class="font-bold text-gray-800 mb-2">Is Heart Attack Genetic? - Hereditary Heart Risk Guide में डॉक्टर को कब दिखाना चाहिए?</h3>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                        <h3 class="font-bold text-gray-800 mb-2">क्या Is Heart Attack Genetic? - Hereditary Heart Risk Guide दूसरी स्वास्थ्य समस्याओं से जुड़ा हो सकता है?</h3>
                        <p class="text-gray-700">हां, कई लक्षण अलग-अलग बीमारियों में मिलते-जुलते हो सकते हैं। इसलिए Heart Attack Se Kaise Bachen: 15 Powerful Tips for a Healthy Heart जैसे संबंधित विषयों को समझना उपयोगी है। जरूरत के अनुसार डॉक्टर जांच, ब्लड टेस्ट, इमेजिंग, ईसीजी या विशेषज्ञ परामर्श की सलाह दे सकते हैं।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
