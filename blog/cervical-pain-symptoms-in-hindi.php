...
<head>
    ...
    <link rel="canonical" href="https://rajhospitals.com/blog/cervical-pain-symptoms-in-hindi.php">
    ...
    <meta property="og:url" content="https://rajhospitals.com/blog/cervical-pain-symptoms-in-hindi.php">
    ...
    <main class="max-w-4xl mx-auto px-4 pb-12">
        <article class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="aspect-[16/9] md:aspect-[21/9] w-full overflow-hidden bg-gray-50 flex items-center justify-center">
                <img src="assets/img/featured/cervical-pain-symptoms-in-hindi.png" alt="गर्दन में दर्द के लक्षण - Cervical Pain Symptoms" class="w-full h-full object-contain">
            </div>
