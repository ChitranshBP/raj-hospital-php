...
<head>
    ...
    <title>लिवर इन्फेक्शन के लक्षण - कारण, निदान और इलाज | RAJ Hospital Ranchi</title>
    <meta name="description" content="लिवर इन्फेक्शन के प्रमुख लक्षण, कारण और घरेलू उपाय जानें। जानें कब डॉक्टर को दिखाना है। Ranchi के best gastroenterologists की advice।">
    <meta name="keywords" content="liver infection symptoms, लिवर इन्फेक्शन, liver infection Hindi, liver disease, jaundice, hepatitis, fatty liver">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://rajhospitals.com/blog/liver-infection-symptoms-in-hindi/">

    <meta property="og:title" content="लिवर इन्फेक्शन के लक्षण - Complete Hindi Guide">
    <meta property="og:description" content="लिवर इन्फेक्शन के प्रमुख लक्षण, कारण और घरेलू उपाय जानें।">
    <meta property="og:type" content="article">
    <meta property="og:url" content="https://rajhospitals.com/blog/liver-infection-symptoms-in-hindi/">
    <meta property="og:image" content="https://rajhospitals.com/blog/assets/img/featured/liver-infection-symptoms-in-hindi.png">
    ...
    <script type="application/ld+json">
{
    ...
    "mainEntity": [
        {
            "@type": "Question",
            "name": "लिवर इन्फेक्शन के लक्षण - कारण, निदान और इलाज में डॉक्टर को कब दिखाना चाहिए?",
            "acceptedAnswer": {
                "@type": "Answer",
        ...
        {
            "@type": "Question",
            "name": "क्या लिवर इन्फेक्शन के लक्षण - कारण, निदान और इलाज दूसरी स्वास्थ्य समस्याओं से जुड़ा हो सकता है?",
            "acceptedAnswer": {
                "@type": "Answer",
    ...
    <script type="application/ld+json">
    {
        ...
        "mainEntityOfPage": "https://rajhospitals.com/blog/liver-infection-symptoms-in-hindi/",
        "inLanguage": "hi-IN"
    }
    </script>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 py-4 text-sm mt-[120px]">
        <nav class="text-gray-500">
            ...
            <span class="mx-2">›</span>
            <span class="text-gray-700">लिवर इन्फेक्शन - Complete Guide</span>
        </nav>
    </div>
    ...
    <main class="max-w-4xl mx-auto px-4 pb-12">
        <article class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="p-6 md:p-10 border-b border-gray-100">
                ...
                <h1 class="text-2xl md:text-3xl font-bold text-gray-800 mb-4">लिवर इन्फेक्शन के लक्षण - कारण, निदान और इलाज</h1>
            ...
            <div class="p-6 md:p-10">
                ...
                <p class="text-lg leading-relaxed text-gray-700 mb-6">
                    क्या आपको <strong>पेट में भारीपन</strong> महसूस होता है? क्या आपकी <strong>आंखों और त्वचा में पीलापन</strong> आ गया है? अगर हाँ, तो यह <strong>लिवर इन्फेक्शन</strong> का संकेत हो सकता है।
                </p>

                <p class="text-gray-700 mb-6">
                    <strong>लिवर</strong> हमारे शरीर का सबसे बड़ा अंग है जो खून को साफ करने, पाचन में मदद करने और विषाक्त पदार्थों को बाहर निकालने का काम करता है। जब लिवर में इन्फेक्शन होता है, तो यह सही से काम नहीं कर पाता और कई गंभीर समस्याएं हो सकती हैं।
                </p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div class="bg-gray-50 p-4 rounded-lg text-center">
                        <div class="text-xl font-bold text-secondary-600 mb-2">Hepatitis A</div>
                        <p class="text-sm text-gray-600">दूषित भोजन और पानी से फैलता है।Vaccine available है।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg text-center">
                        <div class="text-xl font-bold text-secondary-600 mb-2">Hepatitis B</div>
                        <p class="text-sm text-gray-600">खून और शारीरिक तरल पदार्थों से फैलता है। Vaccine available है।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg text-center">
                        <div class="text-xl font-bold text-secondary-600 mb-2">Hepatitis C</div>
                        <p class="text-sm text-gray-600">खून के संपर्क से फैलता है। New treatments available हैं।</p>
                    </div>
                </div>
                ...
                <div class="space-y-4 mb-6">
                    <div class="bg-gray-50 p-4 rounded-lg border-l-4 border-secondary-600">
                        <h4 class="font-bold text-secondary-600">1. पीलिया (Jaundice)</h4>
                        <p class="text-sm text-gray-600">आंखों, त्वचा और नाखूनों में पीलापन। मल में हल्का रंग और पेशाब में गहरा रंग।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border-l-4 border-secondary-600">
                        <h4 class="font-bold text-secondary-600">2. पेट दर्द और सूजन</h4>
                        <p class="text-sm text-gray-600">पेट के ऊपरी दाएं हिस्से में दर्द जहां लिवर होता है। पेट में सूजन (ascites)।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border-l-4 border-secondary-600">
                        <h4 class="font-bold text-secondary-600">3. थकान और कमज़ोरी</h4>
                        <p class="text-sm text-gray-600">बहुत ज्यादा थकान जो आराम से भी न जाए। शरीर में भारी कमज़ोरी।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border-l-4 border-secondary-600">
                        <h4 class="font-bold text-secondary-600">4. भूख न लगना</h4>
                        <p class="text-sm text-gray-600">खाने में मन नहीं लगना, मतली और उल्टी आना।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border-l-4 border-secondary-600">
                        <h4 class="font-bold text-secondary-600">5. बुखार</h4>
                        <p class="text-sm text-gray-600">हल्का या तेज़ बुखार जो लगातार रहे।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border-l-4 border-secondary-600">
                        <h4 class="font-bold text-secondary-600">6. मल का रंग बदलना</h4>
                        <p class="text-sm text-gray-600">मल हल्का या चाकलेट रंग का हो जाना।</p>
                    </div>
                </div>
                ...
                <div class="raj-callout raj-callout-danger">
                    ...
                    <ul class="list-disc list-inside space-y-1 text-gray-700 mt-2">
                        ...
                        <li>लगातार बुखार और उल्टी हो</li>
                        <li>पेशाब का रंग बहुत गहरा हो</li>
                        <li>पेट में सूजन आ गई हो</li>
                        <li>मल का रंग बदल गया हो</li>
                    </ul>
                </div>
                ...
                <div class="space-y-4">
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-bold text-secondary-600 mb-2">क्या लिवर इन्फेक्शन पूरी तरह ठीक हो सकता है?</h4>
                        <p class="text-gray-700">Hepatitis A और E generally पूरी तरह ठीक हो जाते हैं। Hepatitis B और C के लिए treatment available है जो virus को control करता है।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-bold text-secondary-600 mb-2">लिवर इन्फेक्शन कितने दिनों में ठीक होता है?</h4>
                        <p class="text-gray-700">Hepatitis A कुछ हफ्तों में ठीक हो जाता है। B और C का treatment महीनों तक चल सकता है।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-bold text-secondary-600 mb-2">क्या लिवर इन्फेक्शन छूकर फैलता है?</h4>
                ...
                <section class="mt-8 bg-white border border-gray-200 rounded-xl p-5">
                    ...
                    <ul class="list-disc pl-6 space-y-2 text-gray-700">
                        <li><a href="/specialties/gastroenterology" class="text-secondary-600 hover:underline font-semibold">Ranchi में लिवर रोग का इलाज — RAJ Hospital Gastroenterology विभाग, Ranchi</a></li>
                ...
                <section class="mt-8">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                        <h3 class="font-bold text-gray-800 mb-2">क्या लिवर इन्फेक्शन के लक्षण - कारण, निदान और इलाज दूसरी स्वास्थ्य समस्याओं से जुड़ा हो सकता है?</h3>
