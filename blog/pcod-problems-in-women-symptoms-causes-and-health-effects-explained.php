...
<head>
    ...
    <link rel="canonical" href="https://rajhospitals.com/blog/pcod-problems-in-women-symptoms-causes-and-health-effects-explained.php">
    ...
    <meta property="og:url" content="https://rajhospitals.com/blog/pcod-problems-in-women-symptoms-causes-and-health-effects-explained.php">
    ...
    <main class="max-w-4xl mx-auto px-4 pb-12">
        <article class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="aspect-[16/9] md:aspect-[21/9] w-full overflow-hidden bg-gray-50 flex items-center justify-center">
                <img src="assets/img/featured/pcod-problems-in-women-symptoms-causes-and-health-effects-explained.png" alt="PCOD Problems in Women" class="w-full h-full object-contain">
            </div>
