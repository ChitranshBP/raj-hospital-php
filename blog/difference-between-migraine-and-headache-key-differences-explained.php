...
<head>
    ...
    <link rel="canonical" href="https://rajhospitals.com/blog/difference-between-migraine-and-headache-key-differences-explained.php">
    ...
    <meta property="og:url" content="https://rajhospitals.com/blog/difference-between-migraine-and-headache-key-differences-explained.php">
    ...
    <main class="max-w-4xl mx-auto px-4 pb-12">
        <article class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="aspect-[16/9] md:aspect-[21/9] w-full overflow-hidden bg-gray-50 flex items-center justify-center">
                <img src="assets/img/featured/difference-between-migraine-and-headache-key-differences-explained.png" alt="Migraine vs Headache - Key Differences Explained" class="w-full h-full object-contain">
            </div>
            ...
            <div class="p-6 md:p-10">
                ...
                <div class="bg-gradient-to-r from-purple-500 to-blue-600 text-white p-6 rounded-xl text-center mb-8">
                    ...
                    <a href="<?php echo $base_url; ?>contact.php" class="inline-block bg-white text-purple-500 font-bold px-6 py-2 rounded-lg hover:bg-gray-100 transition-colors">Book Appointment</a>
                </div>
