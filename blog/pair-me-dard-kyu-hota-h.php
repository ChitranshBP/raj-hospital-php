...
<head>
    ...
    <title>पैर में दर्द क्यों होता है? - सभी कारण और समाधान | RAJ Hospital Ranchi</title>
    <meta name="description" content="पैर में दर्द क्यों होता है? जानें सभी medical causes - diabetes, nerve damage, poor circulation से लेकर lifestyle factors तक। proper treatment।">
    <meta name="keywords" content="pair me dard kyu hota hai, पैर में दर्द क्यों होता है, foot pain causes, leg pain reasons, पैर दर्द के कारण, diabetes foot pain, nerve pain Hindi">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://rajhospitals.com/blog/pair-me-dard-kyu-hota-h/">

    <meta property="og:title" content="पैर में दर्द क्यों होता है? - सभी कारण और समाधान">
    <meta property="og:description" content="पैर में दर्द क्यों होता है? जानें सभी medical causes और समाधान।">
    <meta property="og:type" content="article">
    <meta property="og:url" content="https://rajhospitals.com/blog/pair-me-dard-kyu-hota-h/">
    <meta property="og:image" content="https://rajhospitals.com/blog/assets/img/featured/pair-me-dard-kyu-hota-h.png">
    ...
    <script type="application/ld+json">
{
    ...
    "mainEntity": [
        {
            "@type": "Question",
            "name": "पैर में दर्द क्यों होता है? - सभी कारण और समाधान में डॉक्टर को कब दिखाना चाहिए?",
            "acceptedAnswer": {
                "@type": "Answer",
    ...
    <script type="application/ld+json">
    {
        ...
        "mainEntityOfPage": "https://rajhospitals.com/blog/pair-me-dard-kyu-hota-h/",
        "inLanguage": "hi-IN"
    }
    </script>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 py-4 text-sm mt-[120px]">
        <nav class="text-gray-500">
            ...
            <span class="mx-2">›</span>
            <span class="text-gray-700">पैर दर्द के कारण - Complete Guide</span>
        </nav>
    </div>
    ...
    <main class="max-w-4xl mx-auto px-4 pb-12">
        <article class="bg-white rounded-xl shadow-md overflow-hidden">
            ...
            <div class="p-6 md:p-10 border-b border-gray-100">
                <span class="inline-block bg-secondary-600 text-white text-xs font-semibold px-3 py-1 rounded-full mb-4">Orthopedics & General</span>
                <h1 class="text-2xl md:text-3xl font-bold text-gray-800 mb-4">पैर में दर्द क्यों होता है? - सभी कारण और समाधान</h1>
            ...
            <div class="p-6 md:p-10">
                ...
                <p class="text-lg leading-relaxed text-gray-700 mb-6">
                    <strong>पैर में दर्द</strong> एक आम समस्या है जो हर उम्र के लोगों को हो सकती है। लेकिन क्या आप जानते हैं कि पैर में दर्द के कई <strong>अलग-अलग कारण</strong> हो सकते हैं?
                </p>

                <p class="text-gray-700 mb-6">
                    कभी-कभी पैर का दर्द सिर्फ थकान से होता है, लेकिन कई बार यह <strong>गंभीर बीमारी</strong> का संकेत भी हो सकता है। इस article में हम विस्तार से जानेंगे कि <strong>पैर में दर्द क्यों होता है</strong> और उसका इलाज क्या है।
                </p>
                ...
                <div class="space-y-4 mb-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border-l-4 border-secondary-600">
                        <h4 class="font-bold text-secondary-600">2. Poor Blood Circulation</h4>
                        <p class="text-sm text-gray-600">पैरों में खून का poor flow दर्द, swelling और थकान का कारण बनता है। <strong>Peripheral artery disease (PAD)</strong> इसका एक common कारण है।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border-l-4 border-secondary-600">
                        <h4 class="font-bold text-secondary-600">3. Peripheral Neuropathy</h4>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border-l-4 border-secondary-600">
                        <h4 class="font-bold text-secondary-600">5. Vitamin Deficiencies</h4>
                        <p class="text-sm text-gray-600">विटामिन B12, B6, B1 या folate की कमी से nerve damage और पैर दर्द हो सकता है।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg border-l-4 border-secondary-600">
                        <h4 class="font-bold text-secondary-600">6. Kidney Disease</h4>
                        <p class="text-sm text-gray-600">किडनी ठीक से काम न करने पर toxins शरीर में जमा होते हैं जो पैरों में दर्द और swelling कर सकते हैं।</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-bold text-secondary-600">Flat Feet (सपाट पैर)</h4>
                        <p class="text-sm text-gray-600">Arch नहीं होने से पैरों पर ज्यादा दबाव पड़ता है।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-bold text-secondary-600">High Arches</h4>
                        <p class="text-sm text-gray-600">ज्यादा arch से pressure points पर दर्द।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-bold text-secondary-600">Plantar Fasciitis</h4>
                        <p class="text-sm text-gray-600">तलवे के fascia ligament में सूजन।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-bold text-secondary-600">Morton's Neuroma</h4>
                        <p class="text-sm text-gray-600">toes के बीच nerve thickening।</p>
                    </div>
                </div>
                ...
                <ul class="list-disc list-inside space-y-2 text-gray-700 mb-6">
                    ...
                    <li><strong>गलत जूते:</strong> Tight या flat shoes जो support नहीं देतीं।</li>
                    <li><strong>मोटापा:</strong> ज्यादा weight से पैरों पर दबाव बढ़ता है।</li>
                    <li><strong>ज्यादा exercise:</strong> नए exercise routine से foot strain।</li>
                    <li><strong>कम पानी पीना:</strong> dehydration से muscle cramps।</li>
                    <li><strong>धूम्रपान:</strong> circulation को प्रभावित करता है।</li>
                </ul>
                ...
                <div class="raj-callout raj-callout-danger">
                    ...
                    <ul class="list-disc list-inside space-y-1 text-gray-700 mt-2">
                        ...
                        <li>रंग बदलाव (नीला या पीला)</li>
                        <li>बहुत सूजन</li>
                        <li>दर्द जो रात को बढ़े</li>
                        <li>बुखार के साथ दर्द</li>
                        <li>पैर की गर्मी महसूस होना</li>
                    </ul>
                </div>
                ...
                <div class="bg-gradient-to-r from-secondary-600 to-blue-600 text-white p-6 rounded-xl text-center mb-8">
                    <h3 class="text-xl font-bold mb-2">पैर दर्द की पूरी जांच करवाएं</h3>
                    <p class="opacity-90 mb-4">RAJ Hospital Ranchi में complete foot assessment, X-Ray और specialized treatment available है।</p>
                ...
                <ul class="list-disc list-inside space-y-2 text-gray-700 mb-6">
                    <li><strong>दवाइयाँ:</strong> Pain killers, anti-inflammatories, gout की दवाइयाँ</li>
                    <li><strong>Physical therapy:</strong> Exercises और stretches</li>
                    <li><strong>Orthotics:</strong> Custom insoles जो support करें</li>
                    <li><strong>Surgery:</strong> गंभीर cases में (bunion, heel spur)</li>
                    <li><strong>Lifestyle changes:</strong> Weight loss, better shoes, regular exercise</li>
                </ul>
                ...
                <div class="space-y-4">
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <h4 class="font-bold text-secondary-600 mb-2">पैर दर्द से कैसे बचें?</h4>
                        <p class="text-gray-700">सही footwear, healthy weight, regular stretching, और breaks लेकर।</p>
                    </div>
                    <div class="bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        ...
                        <p class="text-gray-700">नहीं। छोटा दर्द भी गंभीर condition का संकेत हो सकता है। doctor से consult करें।</p>
                    </div>
                </div>
                ...
                <section class="mt-8">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                        <h3 class="font-bold text-gray-800 mb-2">क्या पैर में दर्द क्यों होता है? - सभी कारण और समाधान दूसरी स्वास्थ्य समस्याओं से जुड़ा हो सकता है?</h3>
