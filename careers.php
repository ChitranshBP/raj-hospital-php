    ...
    <div id="application-modal" class="fixed inset-0 bg-black bg-opacity-75 flex z-50 p-4 hidden overflow-y-auto w-full h-full" onclick="closeApplicationModal()">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-3xl m-auto relative" onclick="event.stopPropagation()">
            ...
            <div class="p-6 md:p-8">
                <form class="space-y-6" action="https://app.formester.com/forms/VeSQzGaag/submissions" method="POST" enctype="multipart/form-data">
                    ...
                    <div id="position-select-container">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Position Applying For *</label>
                         <select id="modal-position-select" name="position" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ea5234] focus:border-transparent outline-none bg-white">
                     ...
                     <div id="custom-position-container" class="hidden">
                        ...
                        <input type="text" id="custom-position-input" name="custom_position" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ea5234] focus:border-transparent outline-none" placeholder="Enter the position you're interested in">
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Years of Experience *</label>
                        <select name="experience" required class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ea5234] focus:border-transparent outline-none bg-white">
                    ...
                    <div>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-[#ea5234] transition-colors cursor-pointer bg-gray-50" onclick="this.querySelector('input').click()">
                            ...
                            <input type="file" name="resume" class="hidden" accept=".pdf,.doc,.docx" required onchange="updateFileName(this)">
                            <p id="file-name" class="text-sm text-[#ea5234] mt-2 font-medium hidden"></p>
                        </div>
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Cover Letter</label>
                        <textarea name="cover_letter" rows="4" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ea5234] focus:border-transparent outline-none" placeholder="Tell us why you're interested in this position..."></textarea>
                    </div>
