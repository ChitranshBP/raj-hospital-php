                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <p class="text-gray-300 leading-relaxed mb-6 text-sm">Raj Hospitals is a leading multi-specialty
                            healthcare provider in Ranchi, Jharkhand, delivering comprehensive medical care with
                            state-of-the-art technology and a patient-centric approach since 1991.</p>
                        <div class="mt-6 space-y-3">
                            <div class="flex items-center space-x-2">
                                <i data-feather="phone" class="w-4 h-4 text-orange-400"></i>
                                <a href="tel:+919771488888"
                                    class="text-gray-300 hover:text-orange-400 text-sm transition-colors">+91 977 14
                                    88888</a>
                            </div>
                            <div class="flex items-center space-x-2">
                                <i data-feather="mail" class="w-4 h-4 text-orange-400"></i>
                                <a href="mailto:info@rajhospitals.com"
                                    class="text-gray-300 hover:text-orange-400 text-sm transition-colors">info@rajhospitals.com</a>
                            </div>
                            <div class="flex items-start space-x-2">
                                <i data-feather="map-pin" class="w-4 h-4 text-orange-400 mt-0.5"></i>
                                <a href="https://maps.google.com/?q=Raj+Hospitals+Bariatu+Road+Ranchi" target="_blank"
                                    class="text-gray-300 hover:text-orange-400 text-sm transition-colors">Ranchi,
                                    Jharkhand - 834009</a>
                            </div>
                        </div>
                        <!-- Social Media -->
                        <div class="mt-6">
                            <h5 class="text-sm font-semibold text-orange-400 uppercase tracking-wide mb-4">Connect With
                                Us</h5>
                            <div class="flex space-x-3">
                                <a href="https://www.facebook.com/RajHospitals" target="_blank" aria-label="Raj Hospitals Facebook"
                                    class="w-11 h-11 bg-gradient-to-br from-orange-500/20 to-orange-600/20 backdrop-blur-sm rounded-xl flex items-center justify-center hover:from-orange-500 hover:to-orange-600 transition-all duration-300 border border-orange-500/30 hover:border-orange-500 group hover:scale-110 text-orange-300 hover:text-white">
                                    <i data-feather="facebook" class="w-5 h-5"></i>
                                </a>
                                <a href="https://www.instagram.com/raj.hospitals/" target="_blank" aria-label="Raj Hospitals Instagram"
                                    class="w-11 h-11 bg-gradient-to-br from-orange-500/20 to-orange-600/20 backdrop-blur-sm rounded-xl flex items-center justify-center hover:from-orange-500 hover:to-orange-600 transition-all duration-300 border border-orange-500/30 hover:border-orange-500 group hover:scale-110 text-orange-300 hover:text-white">
                                    <i data-feather="instagram" class="w-5 h-5"></i>
                                </a>
                                <a href="https://youtube.com/@rajhospitals6364?si=TfGXzxHhg8zqU4O0" target="_blank" aria-label="Raj Hospitals YouTube"
                                    class="w-11 h-11 bg-gradient-to-br from-orange-500/20 to-orange-600/20 backdrop-blur-sm rounded-xl flex items-center justify-center hover:from-orange-500 hover:to-orange-600 transition-all duration-300 border border-orange-500/30 hover:border-orange-500 group hover:scale-110 text-orange-300 hover:text-white">
                                    <i data-feather="youtube" class="w-5 h-5"></i>
                                </a>
                                <a href="https://wa.me/919771488888" target="_blank" aria-label="Raj Hospitals WhatsApp"
                                    class="w-11 h-11 bg-gradient-to-br from-orange-500/20 to-orange-600/20 backdrop-blur-sm rounded-xl flex items-center justify-center hover:from-orange-500 hover:to-orange-600 transition-all duration-300 border border-orange-500/30 hover:border-orange-500 group hover:scale-110 text-orange-300 hover:text-white">
                        ...
                        <ul class="space-y-2.5">
                            ...
                            <li><a href="/biomedical-waste-reports.php"
                                    class="text-gray-300 hover:text-orange-400 transition-colors flex items-center space-x-2 text-sm group"><i
                                        data-feather="chevron-right"
                                        class="w-3 h-3 text-orange-500 group-hover:translate-x-1 transition-transform"></i>
                                    <span>BioMedical Waste Reports</span></a></li>
                        </ul>
                    </div>
                        ...
                        <ul class="space-y-2.5">
                            ...
                            <li><a href="/specialties/oncology-cancer-care.php"
                                    class="text-gray-300 hover:text-orange-400 transition-colors flex items-center space-x-2 text-sm group"><i
                                        data-feather="chevron-right"
                                        class="w-3 h-3 text-orange-500 group-hover:translate-x-1 transition-transform"></i>
                                    <span>Oncology (Cancer Care)</span></a></li>
                        </ul>
                    </div>
...
<!-- Floating Quick Action Buttons alongside WhatsApp widget (Call & YouTube) -->
<div class="fixed bottom-[82px] left-5 sm:left-6 z-50 flex flex-col items-start gap-3 print:hidden" id="floating-quick-actions">
    <!-- Call Button -->
    <a href="tel:+919771488888" aria-label="Call Raj Hospitals at +91 97714 88888"
        class="group relative flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 text-white shadow-xl hover:shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300">
        <span class="absolute left-full ml-3 top-1/2 -translate-y-1/2 px-3 py-1.5 bg-gray-900/90 text-white text-xs font-semibold rounded-lg shadow-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none hidden md:block">
            Call Us: +91 97714 88888
        </span>
    ...
    <!-- YouTube Button -->
    <a href="https://youtube.com/@rajhospitals6364?si=TfGXzxHhg8zqU4O0" target="_blank" rel="noopener noreferrer" aria-label="Raj Hospitals YouTube Channel"
        class="group relative flex items-center justify-center w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-[#FF0000] hover:bg-[#d90000] text-white shadow-xl hover:shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300">
        <span class="absolute left-full ml-3 top-1/2 -translate-y-1/2 px-3 py-1.5 bg-gray-900/90 text-white text-xs font-semibold rounded-lg shadow-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none hidden md:block">
            Watch on YouTube
        </span>
