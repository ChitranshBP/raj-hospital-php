                        ...
                        <div class="lg:col-span-2">
                         ...
                         <div>
                            ...
                            <ul class="space-y-2.5">
                                ...
                                <li><a href="<?php echo $base_url; ?>find-a-doctor.php" class="text-gray-300 hover:text-orange-400 transition-colors flex items-center space-x-2 text-sm group"><i data-feather="chevron-right" class="w-3 h-3 text-orange-500 group-hover:translate-x-1 transition-transform"></i> <span>Find a Doctor</span></a></li>
                                ...
                                <li><a href="<?php echo $base_url; ?>corporate-tpa.php" class="text-gray-300 hover:text-orange-400 transition-colors flex items-center space-x-2 text-sm group"><i data-feather="chevron-right" class="w-3 h-3 text-orange-500 group-hover:translate-x-1 transition-transform"></i> <span>Corporate/TPA Query</span></a></li>
