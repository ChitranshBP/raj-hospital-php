...
<head>
    ...
    <meta name="description" content="Latest news, press releases, and media coverage of Raj Hospital Ranchi. Stay updated on healthcare events, medical achievements, and community initiatives." />
    ...
    <link rel="canonical" href="https://rajhospitals.com/news-media" />

    <!-- Open Graph -->
    <meta property="og:title" content="News & Media | Raj Hospitals" />
    <meta property="og:description" content="Latest news, press releases, and media coverage of Raj Hospital Ranchi." />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="https://rajhospitals.com/news-media" />
...
<body class="bg-white">
    ...
    <script>
        ...
        const digitalNews = [
            ...
            { id: 6, title: 'राज अस्पताल, रांची में मनाया गया 77वां स्वतंत्रता दिवस, ध्वजारोहण कर दी तिरंगे को सलामी', description: '77th Independence Day celebration at Raj Hospital.', image: 'img/img7.webp', link: 'independence-day-23.php', date: 'August 23, 2023' },
            { id: 7, title: 'रांची: 28 जुलाई को मनाया जायेगा विश्व हेपेटाइटिस दिवस', description: 'World Hepatitis Day will be observed on 28 July.', image: 'img/doc.webp', link: 'https://lagatar.in/ranchi-world-hepatitis-day-to-be-celebrated-on-july', date: 'July 28, 2023' },
            { id: 8, title: 'राज अस्पताल में पहली बार IVUS तकनीक से की गई एंजियोप्लास्टी', description: 'IVUS-based angioplasty performed for the first time at Raj Hospital.', image: 'img/cover img.webp', link: 'https://lagatar.in/angioplasty-done-with-ivus-technique-for-the-first-time-in-raj-hospital/', date: 'July 22, 2023' },
            { id: 9, title: 'नर्सों की जितनी प्रशंसा की जाए कम है : साहिल गंभीर', description: 'Nurses appreciation ceremony at Raj Hospital.', image: 'img/Untitled design-00.webp', link: 'https://lagatar.in/the-praise-of-nurses-is-less-sahil-gambhir/', date: 'May 14, 2023' },
            { id: 10, title: 'रांची : राज अस्पताल में अग्निशमन विभाग की ओर से मॉक ड्रिल का आयोजन', description: 'Fire safety week mock drill conducted at Raj Hospital.', image: 'img/1223.webp', link: 'https://lagatar.in/ranchi-mock-drill-organized-by-the-fire-department-in-raj-hospital-the-methods-of-fire-prevention/', date: 'April 16, 2023' },
            { id: 11, title: '15 cases of black fungus in Jharkhand, Centre to hold discussions today.', description: 'TOI coverage of black fungus cases in Jharkhand.', image: 'img/Untitled design.webp', link: 'https://timesofindia.indiatimes.com/city/ranchi/15-cases-of-black-fungus-in-state-centre-to-hold-discussions-today/articleshow/82679927.cms', date: 'May 17, 2021' },
            { id: 12, title: 'सेवा सदन का ओपीडी आज से शुरू होगा, राज अस्पताल में मिल रहा है परामर्श', description: 'Seva Sadan OPD begins, consultations available at Raj Hospital.', image: 'img/Untitled design.webp', link: 'https://www.prabhatkhabar.com/state/jharkhand/ranchi/opd-of-seva-sadan-will-start-from-today-counseling-is-being-provided-in-raj-hospital', date: 'May 12, 2021' },
            { id: 13, title: 'राज अस्पताल के डॉक्टर्स का कमाल, 92 वर्षीय महिला के पेट से निकाला 15 किलो का ट्यूमर', description: 'Doctors at Raj Hospital remove a 15-kg abdominal tumor.', image: 'img/Untitled design.webp', link: 'https://lagatar.in/amazing-doctors-of-raj-hospital-a-15-kg-tumor-removed-from-a-92-year-old-womans-abdomen/', date: 'January 15, 2021' },
            { id: 14, title: 'Jharkhand to start vax drive for senior citizens from today', description: 'Senior citizen vaccination drive begins in Jharkhand.', image: 'img/Untitled design.webp', link: 'http://timesofindia.indiatimes.com/articleshow/81262067.cms', date: 'March 1, 2021' },
            { id: 15, title: 'Only 2 of 71 private hospitals offering jabs in Ranchi', description: 'Vaccination availability report in private hospitals.', image: 'img/Untitled design (1).webp', link: 'https://www.telegraphindia.com/jharkhand/only-2-of-71-private-hospitals-offering-jabs-in-ranchi/cid/1808398', date: 'March 12, 2021' },
             { id: 16, title: '450 pvt hospitals to administer vaccine from today', description: '450 private hospitals authorized for vaccination.', image: 'img/Untitled design (2).webp', link: 'https://www.dailypioneer.com/2021/state-editions/450-pvt-hospitals-to-administer-vaccine-from-today.html', date: 'March 1, 2021' },
            { id: 17, title: 'State allows private hospitals to run 24x7 vaccination programme', description: 'Government permits round-the-clock vaccination.', image: 'img/Untitled design (3).webp', link: 'https://www.dailypioneer.com/2021/state-editions/state-allows-private-hospitals-to-run-24x7-vaccination-programme.html', date: 'June 21, 2021' }
        ];
        ...
        const newspaperClippings = [
            ...
            { id: 38, image: 'assets/press/nurse-day.webp', title: 'नर्स दिवस' },
            { id: 39, image: 'assets/press/WhatsApp Image 2026-05-09 at 10.20.51 AM.webp', title: 'राज अस्पताल प्रेस कवरेज' },
            ...
            { id: 99, image: 'assets/press/independence_day_2026.jpeg', title: 'राज अस्पताल में किया गया झंडोत्तोलन', caption: 'रांची | राज अस्पताल में 80वां स्वतंत्रता दिवस उत्साह और देशभक्ति के साथ मनाया गया। मुख्य अतिथि डॉ. अविनाश कुमार दुबे, एमडी, डीएम-नेफ्रोलॉजी एवं एचओडी, नेफ्रोलॉजी यूनिट ने ध्वजारोहण किया।' },
            ...
            { id: 54, image: 'assets/press/healthc/1.webp', title: 'Health Conclave, 2026', caption: 'Organised by Dainik Jagran on 25th of May, Ranchi. Participated by Dr Rajesh Kumar Jha, Dr Suprova Chakraborty, Dr Himalaya Jha, Dr Bharti Sahni.', category: 'Health Conclave 2026' },
            { id: 55, image: 'assets/press/healthc/2.webp', title: 'Health Conclave, 2026', caption: 'Organised by Dainik Jagran on 25th of May, Ranchi. Participated by Dr Rajesh Kumar Jha, Dr Suprova Chakraborty, Dr Himalaya Jha, Dr Bharti Sahni.', category: 'Health Conclave 2026' }
        ];
